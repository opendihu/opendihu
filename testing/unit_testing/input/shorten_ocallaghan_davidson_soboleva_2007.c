...
void computeRates(double VOI, double *CONSTANTS, double *RATES, double *STATES,
  ...
  RATES[28] =
      (((((CONSTANTS[98] *
           (STATES[18] + STATES[19] + STATES[20] + STATES[21] + STATES[22])) *
              ((STATES[29] - STATES[28]) / CONSTANTS[101]) -
          CONSTANTS[60] *
              ((STATES[28] / (STATES[28] + CONSTANTS[61])) / CONSTANTS[101])) +
         CONSTANTS[62] * ((STATES[29] - STATES[28]) / CONSTANTS[101])) +
        -CONSTANTS[63] * ((STATES[28] - STATES[30]) / CONSTANTS[101])) +
       -((CONSTANTS[70] * STATES[28]) *
             ((CONSTANTS[72] + -STATES[33]) + -STATES[35]) +
         -CONSTANTS[71] * STATES[33])) +
      -((CONSTANTS[78] * STATES[28]) * STATES[43] +
        -CONSTANTS[79] * STATES[39]);
  RATES[29] =
      (((-(CONSTANTS[98] *
           (STATES[18] + STATES[19] + STATES[20] + STATES[21] + STATES[22])) *
             ((STATES[29] - STATES[28]) / CONSTANTS[103]) +
         CONSTANTS[60] *
             ((STATES[28] / (STATES[28] + CONSTANTS[61])) / CONSTANTS[103])) +
        -CONSTANTS[62] * ((STATES[29] - STATES[28]) / CONSTANTS[103])) +
       -CONSTANTS[64] * ((STATES[29] - STATES[31]) / CONSTANTS[103])) +
      -((CONSTANTS[75] * STATES[29]) * (CONSTANTS[77] - STATES[37]) +
        -CONSTANTS[76] * STATES[37]);
  RATES[31] =
      (((CONSTANTS[60] *
             ((STATES[30] / (STATES[30] + CONSTANTS[61])) / CONSTANTS[104]) +
         -CONSTANTS[62] * ((STATES[31] + -STATES[30]) / CONSTANTS[104])) +
        CONSTANTS[64] * ((STATES[29] + -STATES[31]) / CONSTANTS[104])) +
       -((CONSTANTS[75] * STATES[31]) * (CONSTANTS[77] + -STATES[38]) +
         -CONSTANTS[76] * STATES[38])) -
      (1000.00 / 1.00000) *
          (CONSTANTS[95] *
               (STATES[54] * (0.00100000 / 1.00000) * STATES[31] -
                CONSTANTS[97]) *
               (STATES[54] * (0.00100000 / 1.00000) * STATES[31] -
                            CONSTANTS[97] >
                        0.00000
                    ? 1.00000
                    : 0.00000) *
               (0.00100000 / 1.00000) * STATES[54] * STATES[31] -
           CONSTANTS[96] * STATES[55] *
               (CONSTANTS[97] -
                STATES[54] * (0.00100000 / 1.00000) * STATES[31]) *
               (CONSTANTS[97] -
                            STATES[54] * (0.00100000 / 1.00000) * STATES[31] >
                    ...
                    ? 1.00000
                    : 0.00000));
  RATES[33] = (CONSTANTS[70] * STATES[28]) *
                  ((CONSTANTS[72] + -STATES[33]) + -STATES[35]) +
              -CONSTANTS[71] * STATES[33];
  RATES[34] = (CONSTANTS[70] * STATES[30]) *
                  ((CONSTANTS[72] + -STATES[34]) + -STATES[36]) +
              -CONSTANTS[71] * STATES[34];
  RATES[35] = (CONSTANTS[73] * (CONSTANTS[72] + -STATES[33] + -STATES[35])) *
                  STATES[45] +
              -CONSTANTS[74] * STATES[35];
  RATES[36] = (CONSTANTS[73] * (CONSTANTS[72] + -STATES[34] + -STATES[36])) *
                  STATES[46] +
              -CONSTANTS[74] * STATES[36];
  RATES[37] = (CONSTANTS[75] * STATES[29]) * (CONSTANTS[77] + -STATES[37]) +
              -CONSTANTS[76] * STATES[37];
  RATES[38] = (CONSTANTS[75] * STATES[31]) * (CONSTANTS[77] + -STATES[38]) +
              -CONSTANTS[76] * STATES[38];
  RATES[39] = ((CONSTANTS[78] * STATES[28]) * STATES[43] +
               -CONSTANTS[79] * STATES[39]) +
              -CONSTANTS[82] * ((STATES[39] + -STATES[40]) / CONSTANTS[101]);
  RATES[40] = ((CONSTANTS[78] * STATES[30]) * STATES[44] +
               -CONSTANTS[79] * STATES[40]) +
              CONSTANTS[82] * ((STATES[39] + -STATES[40]) / CONSTANTS[102]);
  RATES[41] = ((CONSTANTS[80] * STATES[45]) * STATES[43] +
               -CONSTANTS[81] * STATES[41]) +
              -CONSTANTS[82] * ((STATES[41] + -STATES[42]) / CONSTANTS[101]);
  RATES[42] = ((CONSTANTS[80] * STATES[46]) * STATES[44] +
               -CONSTANTS[81] * STATES[42]) +
              CONSTANTS[82] * ((STATES[41] + -STATES[42]) / CONSTANTS[102]);
  RATES[43] = (-((CONSTANTS[78] * STATES[28]) * STATES[43] +
                 -CONSTANTS[79] * STATES[39]) +
               -((CONSTANTS[80] * STATES[45]) * STATES[43] +
                 -CONSTANTS[81] * STATES[41])) +
              -CONSTANTS[82] * ((STATES[43] + -STATES[44]) / CONSTANTS[101]);
  RATES[44] = (-((CONSTANTS[78] * STATES[30]) * STATES[44] +
                 -CONSTANTS[79] * STATES[40]) +
               -((CONSTANTS[80] * STATES[46]) * STATES[44] +
                 -CONSTANTS[81] * STATES[42])) +
              CONSTANTS[82] * ((STATES[43] + -STATES[44]) / CONSTANTS[102]);
  RATES[45] = (-((CONSTANTS[73] * (CONSTANTS[72] + -STATES[33] + -STATES[35])) *
                     STATES[45] +
                 -CONSTANTS[74] * STATES[35]) +
               -((CONSTANTS[80] * STATES[45]) * STATES[43] +
                 -CONSTANTS[81] * STATES[41])) +
              -CONSTANTS[83] * ((STATES[45] + -STATES[46]) / CONSTANTS[101]);
  RATES[46] = (-((CONSTANTS[73] * (CONSTANTS[72] + -STATES[34] + -STATES[36])) *
                     STATES[46] +
                 -CONSTANTS[74] * STATES[36]) +
               -((CONSTANTS[80] * STATES[46]) * STATES[44] +
                 -CONSTANTS[81] * STATES[42])) +
              CONSTANTS[83] * ((STATES[45] + -STATES[46]) / CONSTANTS[102]);
  RATES[47] = (((CONSTANTS[67] * STATES[30]) * STATES[32] +
                -CONSTANTS[68] * STATES[47]) +
               -CONSTANTS[86] * STATES[47]) +
              CONSTANTS[87] * STATES[50];
  RATES[49] = ((((CONSTANTS[67] * STATES[30] * STATES[48] +
                  -CONSTANTS[68] * STATES[49]) +
                 CONSTANTS[84] * STATES[32]) +
                -CONSTANTS[85] * STATES[49]) +
               (-CONSTANTS[67] * STATES[30]) * STATES[49]) +
              CONSTANTS[68] * STATES[50];
  RATES[50] = (((((CONSTANTS[67] * STATES[30] * STATES[49] +
                   -CONSTANTS[68] * STATES[50]) +
                  CONSTANTS[86] * STATES[47]) +
                 -CONSTANTS[87] * STATES[50]) +
                -CONSTANTS[88] * STATES[50]) +
               CONSTANTS[89] * STATES[51]) +
              CONSTANTS[92] * STATES[52];
  RATES[51] = ((CONSTANTS[88] * STATES[50] + -CONSTANTS[89] * STATES[51]) +
               CONSTANTS[91] * STATES[52]) +
              -CONSTANTS[90] * STATES[51];
  RATES[52] = (-CONSTANTS[91] * STATES[52] + CONSTANTS[90] * STATES[51]) +
              -CONSTANTS[92] * STATES[52];
  RATES[53] =
      (0.00100000 / 1.00000) *
          (CONSTANTS[90] * STATES[51] - CONSTANTS[91] * STATES[52]) +
      -1.00000 * CONSTANTS[93] * STATES[53] +
      -1.00000 * CONSTANTS[94] * ((STATES[53] - STATES[54]) / CONSTANTS[102]);
  RATES[54] =
      CONSTANTS[94] * ((STATES[53] - STATES[54]) / CONSTANTS[104]) -
      1.00000 * (CONSTANTS[95] *
                 ...
                 CONSTANTS[96] * STATES[55] *
                     (CONSTANTS[97] -
                      STATES[54] * (0.00100000 / 1.00000) * STATES[31]) *
                     (CONSTANTS[97] - STATES[54] * (0.00100000 / 1.00000) *
                                          STATES[31] >
                              0.00000
                          ? 1.00000
                          : 0.00000));
  RATES[55] =
      1.00000 *
      (CONSTANTS[95] *
           (STATES[54] * (0.00100000 / 1.00000) * STATES[31] - CONSTANTS[97]) *
           (STATES[54] * (0.00100000 / 1.00000) * STATES[31] - CONSTANTS[97] >
                    0.00000
                ? 1.00000
                : 0.00000) *
           (0.00100000 / 1.00000) * STATES[54] * STATES[31] -
       CONSTANTS[96] * STATES[55] *
           (CONSTANTS[97] - STATES[54] * (0.00100000 / 1.00000) * STATES[31]) *
           (CONSTANTS[97] - STATES[54] * (0.00100000 / 1.00000) * STATES[31] >
                    0.00000
                ? 1.00000
                : 0.00000));
  ALGEBRAIC[12] = CONSTANTS[69] + -STATES[32] + -STATES[47] + -STATES[48] +
                  -STATES[49] + -STATES[50] + -STATES[51] + -STATES[52];
  RATES[30] =
      ((((-CONSTANTS[60] *
              ((STATES[30] / (STATES[30] + CONSTANTS[61])) / CONSTANTS[102]) +
          CONSTANTS[62] * ((STATES[31] + -STATES[30]) / CONSTANTS[102])) +
         CONSTANTS[63] * ((STATES[28] - STATES[30]) / CONSTANTS[102])) +
        -(((((((CONSTANTS[67] * STATES[30] * ALGEBRAIC[12] +
                -CONSTANTS[68] * STATES[32]) +
               CONSTANTS[67] * STATES[30] * STATES[32]) +
              -CONSTANTS[68] * STATES[47]) +
             CONSTANTS[67] * STATES[30] * STATES[48]) +
            -CONSTANTS[68] * STATES[49]) +
           CONSTANTS[67] * STATES[30] * STATES[49]) +
          -CONSTANTS[68] * STATES[50])) +
       -((CONSTANTS[70] * STATES[30]) *
             (CONSTANTS[72] + -STATES[34] + -STATES[36]) +
         -CONSTANTS[71] * STATES[34])) +
      -((CONSTANTS[78] * STATES[30]) * STATES[44] +
        -CONSTANTS[79] * STATES[40]);
  RATES[32] = (((((CONSTANTS[67] * STATES[30]) * ALGEBRAIC[12] +
                  -CONSTANTS[68] * STATES[32]) +
                 (-CONSTANTS[67] * STATES[30]) * STATES[32]) +
                CONSTANTS[68] * STATES[47]) +
               -CONSTANTS[84] * STATES[32]) +
              CONSTANTS[85] * STATES[49];
  RATES[48] = (((-CONSTANTS[67] * STATES[30]) * STATES[48] +
                CONSTANTS[68] * STATES[49]) +
               CONSTANTS[84] * ALGEBRAIC[12]) +
              -CONSTANTS[85] * STATES[48];
  ALGEBRAIC[1] =
      CONSTANTS[16] *
      ((STATES[0] - CONSTANTS[21]) /
       (1.00000 - exp(-((STATES[0] - CONSTANTS[21]) / CONSTANTS[32]))));
  ALGEBRAIC[14] =
      CONSTANTS[19] * exp(-((STATES[0] - CONSTANTS[21]) / CONSTANTS[34]));
  RATES[8] = ALGEBRAIC[1] * (1.00000 - STATES[8]) - ALGEBRAIC[14] * STATES[8];
  ALGEBRAIC[2] =
      1.00000 / (1.00000 + exp((STATES[0] - CONSTANTS[25]) / CONSTANTS[28]));
  ALGEBRAIC[15] = 1000.00 * exp(-((STATES[0] + 40.0000) / 25.7500));
  RATES[9] = (ALGEBRAIC[2] - STATES[9]) / ALGEBRAIC[15];
  ALGEBRAIC[4] =
      CONSTANTS[15] *
      ((STATES[0] - CONSTANTS[20]) /
       (1.00000 - exp(-((STATES[0] - CONSTANTS[20]) / CONSTANTS[31]))));
  ALGEBRAIC[17] =
      CONSTANTS[18] * exp(-((STATES[0] - CONSTANTS[20]) / CONSTANTS[33]));
  RATES[10] =
      ALGEBRAIC[4] * (1.00000 - STATES[10]) - ALGEBRAIC[17] * STATES[10];
  ALGEBRAIC[3] =
      CONSTANTS[14] * exp(-((STATES[0] - CONSTANTS[22]) / CONSTANTS[29]));
  ALGEBRAIC[16] =
      CONSTANTS[17] /
      (1.00000 + exp(-((STATES[0] - CONSTANTS[22]) / CONSTANTS[30])));
  RATES[11] =
      ALGEBRAIC[3] * (1.00000 - STATES[11]) - ALGEBRAIC[16] * STATES[11];
  ALGEBRAIC[5] =
      1.00000 / (1.00000 + exp((STATES[0] - CONSTANTS[24]) / CONSTANTS[27]));
  ALGEBRAIC[18] =
      8571.00 / (0.200000 +
                 5.65000 * pow((STATES[0] + CONSTANTS[48]) / 100.000, 2.00000));
  RATES[12] = (ALGEBRAIC[5] - STATES[12]) / ALGEBRAIC[18];
  ALGEBRAIC[6] =
      CONSTANTS[16] *
      ((STATES[1] - CONSTANTS[21]) /
       (1.00000 - exp(-((STATES[1] - CONSTANTS[21]) / CONSTANTS[32]))));
  ALGEBRAIC[19] =
      CONSTANTS[19] * exp(-((STATES[1] - CONSTANTS[21]) / CONSTANTS[34]));
  RATES[13] =
      ALGEBRAIC[6] * (1.00000 - STATES[13]) - ALGEBRAIC[19] * STATES[13];
  ALGEBRAIC[7] =
      1.00000 / (1.00000 + exp((STATES[1] - CONSTANTS[25]) / CONSTANTS[28]));
  ALGEBRAIC[20] = 1.00000 * exp(-((STATES[1] + 40.0000) / 25.7500));
  RATES[14] = (ALGEBRAIC[7] - STATES[14]) / ALGEBRAIC[20];
  ALGEBRAIC[9] =
      CONSTANTS[15] *
      ((STATES[1] - CONSTANTS[20]) /
       (1.00000 - exp(-((STATES[1] - CONSTANTS[20]) / CONSTANTS[31]))));
  ALGEBRAIC[22] =
      CONSTANTS[18] * exp(-((STATES[1] - CONSTANTS[20]) / CONSTANTS[33]));
  RATES[15] =
      ALGEBRAIC[9] * (1.00000 - STATES[15]) - ALGEBRAIC[22] * STATES[15];
  ALGEBRAIC[8] =
      CONSTANTS[14] * exp(-((STATES[1] - CONSTANTS[22]) / CONSTANTS[29]));
  ALGEBRAIC[21] =
      CONSTANTS[17] /
      (1.00000 + exp(-((STATES[1] - CONSTANTS[22]) / CONSTANTS[30])));
  RATES[16] =
      ALGEBRAIC[8] * (1.00000 - STATES[16]) - ALGEBRAIC[21] * STATES[16];
  ALGEBRAIC[10] =
      1.00000 / (1.00000 + exp((STATES[1] - CONSTANTS[24]) / CONSTANTS[27]));
  ALGEBRAIC[23] =
      8571.00 / (0.200000 +
                 5.65000 * pow((STATES[1] + CONSTANTS[48]) / 100.000, 2.00000));
  RATES[17] = (ALGEBRAIC[10] - STATES[17]) / ALGEBRAIC[23];
  ALGEBRAIC[11] = 0.500000 * CONSTANTS[57] *
                  exp((STATES[1] - CONSTANTS[59]) / (8.00000 * CONSTANTS[58]));
  ALGEBRAIC[24] = 0.500000 * CONSTANTS[57] *
                  exp((CONSTANTS[59] - STATES[1]) / (8.00000 * CONSTANTS[58]));
  RATES[23] = -CONSTANTS[54] * STATES[23] + CONSTANTS[55] * STATES[18] +
              -4.00000 * ALGEBRAIC[11] * STATES[23] +
              ALGEBRAIC[24] * STATES[24];
  RATES[18] = CONSTANTS[54] * STATES[23] + -CONSTANTS[55] * STATES[18] +
              (-4.00000 * ALGEBRAIC[11] * STATES[18]) / CONSTANTS[56] +
              CONSTANTS[56] * ALGEBRAIC[24] * STATES[19];
  RATES[24] = 4.00000 * ALGEBRAIC[11] * STATES[23] +
              -ALGEBRAIC[24] * STATES[24] +
              (-CONSTANTS[54] * STATES[24]) / CONSTANTS[56] +
              CONSTANTS[56] * CONSTANTS[55] * STATES[19] +
              -3.00000 * ALGEBRAIC[11] * STATES[24] +
              2.00000 * ALGEBRAIC[24] * STATES[25];
  RATES[19] = (CONSTANTS[54] * STATES[24]) / CONSTANTS[56] +
              -CONSTANTS[55] * CONSTANTS[56] * STATES[19] +
              (4.00000 * ALGEBRAIC[11] * STATES[18]) / CONSTANTS[56] +
              -CONSTANTS[56] * ALGEBRAIC[24] * STATES[19] +
              (-3.00000 * ALGEBRAIC[11] * STATES[19]) / CONSTANTS[56] +
              2.00000 * CONSTANTS[56] * ALGEBRAIC[24] * STATES[20];
  RATES[25] = 3.00000 * ALGEBRAIC[11] * STATES[24] +
              -2.00000 * ALGEBRAIC[24] * STATES[25] +
              (-CONSTANTS[54] * STATES[25]) / pow(CONSTANTS[56], 2.00000) +
              pow(CONSTANTS[56], 2.00000) * CONSTANTS[55] * STATES[20] +
              -2.00000 * ALGEBRAIC[11] * STATES[25] +
              3.00000 * ALGEBRAIC[24] * STATES[26];
  RATES[20] = (3.00000 * ALGEBRAIC[11] * STATES[19]) / CONSTANTS[56] +
              -2.00000 * CONSTANTS[56] * ALGEBRAIC[24] * STATES[20] +
              (CONSTANTS[54] * STATES[25]) / pow(CONSTANTS[56], 2.00000) +
              -CONSTANTS[55] * pow(CONSTANTS[56], 2.00000) * STATES[20] +
              (-2.00000 * ALGEBRAIC[11] * STATES[20]) / CONSTANTS[56] +
              3.00000 * CONSTANTS[56] * ALGEBRAIC[24] * STATES[21];
  RATES[26] = 2.00000 * ALGEBRAIC[11] * STATES[25] +
              -3.00000 * ALGEBRAIC[24] * STATES[26] +
              (-CONSTANTS[54] * STATES[26]) / pow(CONSTANTS[56], 3.00000) +
              CONSTANTS[55] * pow(CONSTANTS[56], 3.00000) * STATES[21] +
              -ALGEBRAIC[11] * STATES[26] +
              4.00000 * ALGEBRAIC[24] * STATES[27];
  RATES[21] = (CONSTANTS[54] * STATES[26]) / pow(CONSTANTS[56], 3.00000) +
              -CONSTANTS[55] * pow(CONSTANTS[56], 3.00000) * STATES[21] +
              (2.00000 * ALGEBRAIC[11] * STATES[20]) / CONSTANTS[56] +
              -3.00000 * ALGEBRAIC[24] * CONSTANTS[56] * STATES[21] +
              (-ALGEBRAIC[11] * STATES[21]) / CONSTANTS[56] +
              4.00000 * CONSTANTS[56] * ALGEBRAIC[24] * STATES[22];
  RATES[27] = ALGEBRAIC[11] * STATES[26] +
              -4.00000 * ALGEBRAIC[24] * STATES[27] +
              (-CONSTANTS[54] * STATES[27]) / pow(CONSTANTS[56], 4.00000) +
              CONSTANTS[55] * pow(CONSTANTS[56], 4.00000) * STATES[22];
  RATES[22] = (ALGEBRAIC[11] * STATES[21]) / CONSTANTS[56] +
              -4.00000 * CONSTANTS[56] * ALGEBRAIC[24] * STATES[22] +
              (CONSTANTS[54] * STATES[27]) / pow(CONSTANTS[56], 4.00000) +
              -CONSTANTS[55] * pow(CONSTANTS[56], 4.00000) * STATES[22];
  ALGEBRAIC[30] =
      STATES[0] *
      ((STATES[3] - STATES[4] * exp((-1.00000 * CONSTANTS[6] * STATES[0]) /
                                    (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 - exp((-1.00000 * CONSTANTS[6] * STATES[0]) /
                      (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[13] = ((CONSTANTS[35] * CONSTANTS[36]) / CONSTANTS[6]) *
                  log(STATES[4] / STATES[3]);
  ALGEBRAIC[37] =
      STATES[4] * exp((-CONSTANTS[41] * ALGEBRAIC[13]) *
                      (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36])));
  ALGEBRAIC[38] =
      CONSTANTS[40] * (pow(ALGEBRAIC[37], 2.00000) /
                       (CONSTANTS[42] + pow(ALGEBRAIC[37], 2.00000)));
  ALGEBRAIC[39] =
      1.00000 -
      pow(1.00000 + (CONSTANTS[43] *
                     (1.00000 + pow(ALGEBRAIC[37], 2.00000) / CONSTANTS[42])) /
                        (pow(CONSTANTS[46], 2.00000) *
                         exp((2.00000 * (1.00000 - CONSTANTS[41]) * STATES[0] *
                              CONSTANTS[6]) /
                             (CONSTANTS[35] * CONSTANTS[36]))),
          -1.00000);
  ...
  ALGEBRAIC[48] =
      pow(1.00000 +
              0.120000 * exp(-0.100000 * STATES[0] *
                             (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36]))) +
              0.0400000 * ALGEBRAIC[47] *
                  exp(-(STATES[0] *
                        (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36])))),
          -1.00000);
  ALGEBRAIC[49] =
      CONSTANTS[6] *
      (CONSTANTS[47] / (pow(1.00000 + CONSTANTS[44] / STATES[4], 2.00000) *
                        pow(1.00000 + CONSTANTS[45] / STATES[5], 3.00000)));
  ALGEBRAIC[50] = ALGEBRAIC[49] * ALGEBRAIC[48];
  RATES[4] = (ALGEBRAIC[41] + ALGEBRAIC[43] + CONSTANTS[12] +
              -2.00000 * ALGEBRAIC[50]) /
                 ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[5]) +
             (STATES[2] - STATES[4]) / CONSTANTS[10];
  ALGEBRAIC[45] =
      ((CONSTANTS[39] * pow(STATES[10], 3.00000)) * STATES[11]) * STATES[12];
  ALGEBRAIC[44] =
      STATES[0] *
      ((STATES[5] - STATES[7] * exp((-1.00000 * CONSTANTS[6] * STATES[0]) /
                                    (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 - exp((-1.00000 * CONSTANTS[6] * STATES[0]) /
                      (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[46] = ALGEBRAIC[45] * (ALGEBRAIC[44] / 75.0000);
  RATES[7] = (ALGEBRAIC[46] + CONSTANTS[13] + 3.00000 * ALGEBRAIC[50]) /
                 ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[5]) +
             (STATES[6] - STATES[7]) / CONSTANTS[11];
  ...
  ALGEBRAIC[34] =
      STATES[0] *
      ((ALGEBRAIC[26] - ALGEBRAIC[27] * exp((CONSTANTS[6] * STATES[0]) /
                                            (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 -
        exp((CONSTANTS[6] * STATES[0]) / (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[33] =
      1.00000 / (1.00000 + exp((STATES[0] - CONSTANTS[23]) / CONSTANTS[26]));
  ...
  ALGEBRAIC[32] = (VOI >= 0.00000 && VOI < 0.500000  ? 150.000
                   : VOI >= 50.0000 && VOI < 50.5000 ? 150.000
                   : VOI >= 100.000 && VOI < 100.500 ? 150.000
                   : VOI >= 150.000 && VOI < 150.500 ? 150.000
                   : VOI >= 200.000 && VOI < 200.500 ? 150.000
                   : VOI >= 250.000 && VOI < 250.500 ? 150.000
                   : VOI >= 300.000 && VOI < 300.500 ? 150.000
                   : VOI >= 350.000 && VOI < 350.500 ? 150.000
                   : VOI >= 400.000 && VOI < 400.500 ? 150.000
                                                     : 0.00000);
  ALGEBRAIC[51] = ALGEBRAIC[36] + ALGEBRAIC[41] + ALGEBRAIC[43] +
                  ALGEBRAIC[46] + ALGEBRAIC[50] + -ALGEBRAIC[32];
  RATES[0] = -((ALGEBRAIC[51] + ALGEBRAIC[0]) / CONSTANTS[0]);
  ALGEBRAIC[31] =
      STATES[1] *
      ((STATES[3] - STATES[2] * exp((-1.00000 * CONSTANTS[6] * STATES[1]) /
                                    (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 - exp((-1.00000 * CONSTANTS[6] * STATES[1]) /
                      (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[25] = ((CONSTANTS[35] * CONSTANTS[36]) / CONSTANTS[6]) *
                  log(STATES[2] / STATES[3]);
  ALGEBRAIC[56] =
      STATES[2] * exp((-CONSTANTS[41] * ALGEBRAIC[25]) *
                      (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36])));
  ALGEBRAIC[57] =
      CONSTANTS[40] * (pow(ALGEBRAIC[56], 2.00000) /
                       (CONSTANTS[42] + pow(ALGEBRAIC[56], 2.00000)));
  ALGEBRAIC[58] =
      1.00000 -
      pow(1.00000 + (CONSTANTS[43] *
                     (1.00000 + pow(ALGEBRAIC[56], 2.00000) / CONSTANTS[42])) /
                        (pow(CONSTANTS[46], 2.00000) *
                         exp((2.00000 * (1.00000 - CONSTANTS[41]) * STATES[1] *
                              CONSTANTS[6]) /
                             (CONSTANTS[35] * CONSTANTS[36]))),
          -1.00000);
  ...
  ALGEBRAIC[67] =
      pow(1.00000 +
              0.120000 * exp(-0.100000 * STATES[1] *
                             (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36]))) +
              0.0400000 * ALGEBRAIC[66] *
                  exp(-(STATES[1] *
                        (CONSTANTS[6] / (CONSTANTS[35] * CONSTANTS[36])))),
          -1.00000);
  ALGEBRAIC[68] =
      CONSTANTS[6] *
      (CONSTANTS[47] / (pow(1.00000 + CONSTANTS[44] / STATES[2], 2.00000) *
                        pow(1.00000 + CONSTANTS[45] / STATES[5], 3.00000)));
  ALGEBRAIC[69] = CONSTANTS[53] * ALGEBRAIC[68] * ALGEBRAIC[67];
  RATES[3] =
      -CONSTANTS[9] * ((ALGEBRAIC[60] + ALGEBRAIC[62] + CONSTANTS[12] +
                        -2.00000 * ALGEBRAIC[69]) /
                       ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[3])) -
      (ALGEBRAIC[41] + ALGEBRAIC[43] + CONSTANTS[12] +
       -2.00000 * ALGEBRAIC[50]) /
          ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[4]);
  RATES[2] = (ALGEBRAIC[60] + ALGEBRAIC[62] + CONSTANTS[12] +
              -2.00000 * ALGEBRAIC[69]) /
                 ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[3]) -
             (STATES[2] - STATES[4]) / CONSTANTS[7];
  ALGEBRAIC[64] =
      ((CONSTANTS[39] * pow(STATES[15], 3.00000)) * STATES[16]) * STATES[17];
  ALGEBRAIC[63] =
      STATES[1] *
      ((STATES[5] - STATES[6] * exp((-1.00000 * CONSTANTS[6] * STATES[1]) /
                                    (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 - exp((-1.00000 * CONSTANTS[6] * STATES[1]) /
                      (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[65] = CONSTANTS[52] * ALGEBRAIC[64] * (ALGEBRAIC[63] / 75.0000);
  RATES[5] = -CONSTANTS[9] *
                 ((ALGEBRAIC[65] + CONSTANTS[13] + 3.00000 * ALGEBRAIC[69]) /
                  ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[3])) -
             (ALGEBRAIC[46] + CONSTANTS[13] + 3.00000 * ALGEBRAIC[50]) /
                 ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[4]);
  RATES[6] = (ALGEBRAIC[65] + CONSTANTS[13] + 3.00000 * ALGEBRAIC[69]) /
                 ((1000.00 / 1.00000) * CONSTANTS[6] * CONSTANTS[3]) -
             (STATES[6] - STATES[7]) / CONSTANTS[8];
  ALGEBRAIC[28] = 156.500 / (5.00000 + exp((-CONSTANTS[6] * ALGEBRAIC[25]) /
                                           (CONSTANTS[35] * CONSTANTS[36])));
  ALGEBRAIC[29] = 156.500 - 5.00000 * ALGEBRAIC[28];
  ALGEBRAIC[53] =
      STATES[1] *
      ((ALGEBRAIC[28] - ALGEBRAIC[29] * exp((CONSTANTS[6] * STATES[1]) /
                                            (CONSTANTS[35] * CONSTANTS[36]))) /
       (1.00000 -
        exp((CONSTANTS[6] * STATES[1]) / (CONSTANTS[35] * CONSTANTS[36]))));
  ALGEBRAIC[52] =
      1.00000 / (1.00000 + exp((STATES[1] - CONSTANTS[23]) / CONSTANTS[26]));
  ALGEBRAIC[54] = CONSTANTS[37] * pow(ALGEBRAIC[52], 4.00000);
  ALGEBRAIC[55] = CONSTANTS[49] * ALGEBRAIC[54] * (ALGEBRAIC[53] / 45.0000);
  ALGEBRAIC[70] = ALGEBRAIC[55] + ALGEBRAIC[60] + ALGEBRAIC[62] +
                  ALGEBRAIC[65] + ALGEBRAIC[69];
