...
purge_dependencies:
	cd dependencies; rm -rf adios/ base64/ easyloggingpp/ googletest/ hdf5/ libxml2/ nlohmannjson/ opencor/ petsc/ precice/ python/ pythonpackages/ semt/ std_simd/ vc/ xbraid/; cd -
