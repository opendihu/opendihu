 ...
 * It is capable of exactly integrating polynomials of degree
 * NumberIntegrationPoints-1.
...
public:
  ...
  template <typename ValueType>
  static ValueType
  computeIntegral(const typename std::array<
                  ValueType,
                  ClenshawCurtis<NumberIntegrationPoints>::numberEvaluations()>
                      &evaluations);
};
