 ...
 *  This class also does some postprocessing like resampling of the streamlines
 * to create equidistant elements. The actual tracing is done in the base class.
 */
template <typename DiscretizableInTimeType>
class StreamlineTracer : public StreamlineTracerBase<
...
protected:
  ...
  //! drop streamlines that are smaller than  discardRelativeLength_*median
  //! streamline length and resample to match targetElementLength_
  ...
  Data::StreamlineTracer<typename DiscretizableInTimeType::FunctionSpace,
                         typename DiscretizableInTimeType::Data>
