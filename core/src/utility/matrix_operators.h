...
/** This file contains elemental operators for MathUtility::Matrix objects which
 * are basically `std::array<double,nRows*nColumns>`.
 */
...
operator-(MathUtility::Matrix<nRows, nColumns, double_v_t> matrix1,
          MathUtility::Matrix<nRows, nColumns, double_v_t> matrix2);
...
operator*(double_v1_t lambda,
          MathUtility::Matrix<nRows, nColumns, double_v2_t> matrix);
