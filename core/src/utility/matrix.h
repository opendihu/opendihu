...
struct Matrix : public std::array<double_v_t, nRows * nColumns>
// public Vc::array<double, nRows*nColumns>
{
  // std::array<double, nRows*nColumns> data;   //< the data member containing
  ...
  operator=(const Matrix<nRows, nColumns, double_v_t> &) = default;

  //! default move assignment operator
  Matrix<nRows, nColumns, double_v_t> &
  operator=(Matrix<nRows, nColumns, double_v_t> &&) = default;
