...
public:
  ...
  void initializeMappingsBetweenMeshes(
 ...
 *  It initializes the mappings between two function spaces FunctionSpace1Type
 * and FunctionSpace2Type.
 *
 *  This needs to be a helper class, because if FunctionSpace1Type is a
 * composite mesh, it first needs to initialize all mappings between the
 * submeshes of the composite mesh and the target mesh.
 */
template <typename FunctionSpace1Type, typename FunctionSpace2Type>
class InitializeMappingsHelper {
public:
  //! version for non-composite mesh in functionSpace1
  static void initializeMappingsBetweenMeshes(
