...
class MappingBetweenMeshesImplementation
    : public MappingBetweenMeshesConstruct<FunctionSpaceSourceType,
                                           FunctionSpaceTargetType> {
public:
  //! constructor
  using MappingBetweenMeshesConstruct<
      FunctionSpaceSourceType,
      FunctionSpaceTargetType>::MappingBetweenMeshesConstruct;

  //! map data between a single component of the field variables in the source
  //! and target function spaces
  ...
  //! map data between all components of the field variables in the source and
  //! target function spaces the naming of the parameters is such that
  //! source->target, however the data types have swapped source/target
  //! semantics, because the mapping is the reverse one.
  template <int nComponents>
  ...
  //! map data between between a single component of the field variables in the
  //! source and target function spaces the naming of the parameters is such
  //! that source->target, however the data types have swapped source/target
  //! semantics, because the mapping is the reverse one.
