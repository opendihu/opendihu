...
public:
  typedef typename TimeSteppingImplicitType::DiscretizableInTime
...
protected:
  ...
  // std::shared_ptr<Data::TimeSteppingImplicit<typename
  // DiscretizableInTimeType::FunctionSpace,
  // DiscretizableInTimeType::nComponents()>> dataImplicit_;  //< a pointer to
  // the data_ object but of type Data::TimeSteppingImplicit
