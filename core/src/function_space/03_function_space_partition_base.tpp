...
FunctionSpacePartitionBase<MeshType, BasisFunctionType>::
    ...
    : FunctionSpaceJacobian<MeshType, BasisFunctionType>(specificSettings),
      partitionManager_(partitionManager),
      forcePartitioningCreationFromLocalNumberOfElements_(false) {}

template <typename MeshType, typename BasisFunctionType>
void FunctionSpacePartitionBase<MeshType, BasisFunctionType>::setMeshPartition(
...
std::shared_ptr<Partition::MeshPartition<
    FunctionSpace<MeshType, BasisFunctionType>, MeshType>>
FunctionSpacePartitionBase<MeshType, BasisFunctionType>::meshPartition() const {
  return meshPartition_;
}

template <typename MeshType, typename BasisFunctionType>
std::shared_ptr<Partition::MeshPartitionBase>
FunctionSpacePartitionBase<MeshType, BasisFunctionType>::meshPartitionBase() {
