...
class FunctionSpaceNumbers<Mesh::CompositeOfDimension<D>, BasisFunctionType>
    : public FunctionSpacePartition<Mesh::CompositeOfDimension<D>,
                                    BasisFunctionType> {
public:
  //! inherit constructor
  using FunctionSpacePartition<Mesh::CompositeOfDimension<D>,
 ...
 */
template <int D, typename BasisFunctionType>
class FunctionSpaceNumbersCommon<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>
    : public FunctionSpaceNumbers<Mesh::CompositeOfDimension<D>,
                                  BasisFunctionType> {
public:
  //! inherit constructor
  using FunctionSpaceNumbers<Mesh::CompositeOfDimension<D>,
                             BasisFunctionType>::FunctionSpaceNumbers;
