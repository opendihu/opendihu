...
public:
  ...
  using FunctionSpaceGeometry<MeshType,
  ...
  //! return number of nodes in specified coordinate direction that are owned by
  //! this partition
  ...
  //! return number of nodes in specified coordinate direction for the whole
  //! global domain
...
protected:
  // if BasisFunction is Hermite, set the derivative values in the geometry
  // field to mean distance between nodes in the corresponding (x,y,z)-direction
