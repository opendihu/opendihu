...
public:
  //! inherit constructor
  using FunctionSpacePointInElement<
      MeshType, BasisFunctionType>::FunctionSpacePointInElement;
  ...
  //! return an array of all dof nos. of the element, including ghost dofs
  //! (local dof nos)
  ...
  void
  getElementDofNosLocalWithoutGhosts(element_no_t elementNo,
                                     std::vector<dof_no_t> &dofNosLocal) const;

  //! fill a vector of all local dof nos. of the element, including ghost dofs
  void getElementDofNosLocal(element_no_t elementNo,
                             std::vector<dof_no_t> &localDofNos) const;
