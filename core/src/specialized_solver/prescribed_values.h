...
/** A dummy solver that sets its field variables to prescribed values that are
 * given by a callback function in the python settings.
 */
template <typename FunctionSpaceType, int nComponents1 = 1,
          int nComponents2 = 1>
class PrescribedValues : public Runnable,
