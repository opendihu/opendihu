...
class MyNewTimesteppingSolver : public Runnable,
...
public:
  ...
  // typedef typename TimeStepping::Data Data;   // either, if you do not need
  // your own data object, use the data object of TimeStepping
