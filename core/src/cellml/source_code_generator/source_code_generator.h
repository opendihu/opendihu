...
class CellmlSourceCodeGenerator : public CellmlSourceCodeGeneratorGpu {
public:
  //! constructor
  ...
  //! @param useAoVSMemoryLayout which memory layout to use for the vc
  //! optimization type, true=Array-of-Vectorized-Struct,
