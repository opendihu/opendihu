...
class CellmlSourceCodeGeneratorGpu : public CellmlSourceCodeGeneratorVc {
public:
  ...
  void generateSourceFastMonodomainGpu(bool approximateExponentialFunction,
                                       int nFibersToCompute,
                                       int nInstancesToComputePerFiber,
                                       int nParametersPerInstance,
                                       bool hasAlgebraicsForTransfer,
