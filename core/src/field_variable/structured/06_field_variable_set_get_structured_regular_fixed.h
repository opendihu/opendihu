...
public:
  ...
  using FieldVariableSetGetComponent<FunctionSpaceType,
                                     nComponents>::FieldVariableSetGetComponent;

  using FieldVariableSetGetComponent<FunctionSpaceType, nComponents>::getValues;
  using FieldVariableSetGetComponent<FunctionSpaceType,
                                     nComponents>::getElementValues;
  using FieldVariableSetGetComponent<FunctionSpaceType, nComponents>::getValue;
  using FieldVariableSetGetComponent<FunctionSpaceType,
                                     nComponents>::getValuesWithGhosts;
  using FieldVariableSetGetComponent<FunctionSpaceType,
                                     nComponents>::getValuesWithoutGhosts;
...
private:
  //! get the derivative dof value for the geometry field, component componentNo
  //! (x,y or z) when using Hermite polynomials
  double getGeometryFieldHermiteDerivative(int nodeLocalDofIndex,
