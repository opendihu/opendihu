...
class FieldVariableSetGet<
    FunctionSpace::FunctionSpace<Mesh::StructuredRegularFixedOfDimension<D>,
                                 BasisFunctionType>,
    nComponents>
    : public FieldVariableSetGetRegularFixed<
...
public:
  ...
  using FieldVariableSetGetRegularFixed<
      FunctionSpace::FunctionSpace<Mesh::StructuredRegularFixedOfDimension<D>,
                                   BasisFunctionType>,
      nComponents>::FieldVariableSetGetRegularFixed;
  using FieldVariableSetGetRegularFixed<
      FunctionSpace::FunctionSpace<Mesh::StructuredRegularFixedOfDimension<D>,
                                   BasisFunctionType>,
...
public:
  ...
  //! inherited constructor
  using FieldVariableSetGetRegularFixed<FunctionSpaceType,
                                        1>::FieldVariableSetGetRegularFixed;
};
