...
class FieldVariableSetGetStructured
    : public FieldVariableDataStructuredForSurface<FunctionSpaceType,
                                                   nComponents> {
public:
  //! inherited constructor
  using FieldVariableDataStructuredForSurface<
      FunctionSpaceType, nComponents>::FieldVariableDataStructuredForSurface;

  using FieldVariableDataStructuredForSurface<FunctionSpaceType,
                                              nComponents>::setValues;
  ...
  void getElementValues(
      int componentNo, element_no_t elementNoLocal,
  ...
  //! extract the specified component from the field variable (by copying it)
  //! and store it in the given field variable (which already has the data
  //! allocated)
  ...
  //! usable again, the restored array was from componentNo
  ...
  //! finishGhostManipulation has to be called to apply the cached changes
  void setValues(int nValues, const std::vector<dof_no_t> &dofNosLocal,
                 const std::vector<std::array<double, nComponents>> &values,
                 InsertMode petscInsertMode = INSERT_VALUES);
