...
public:
  ...
  using FieldVariableSetGetStructured<
      FunctionSpaceType, nComponents>::FieldVariableSetGetStructured;
...
public:
  //! inherited constructors
  using FieldVariableSetGetStructured<FunctionSpaceType,
                                      1>::FieldVariableSetGetStructured;
  ...
  //! get a single value from local dof no. for all components
  double getValue(dof_no_t dofLocalNo) const;
  ...
  //! set values for the single component for dofs, after all calls to
