...
public:
  ...
  using FieldVariableBaseFunctionSpace<
  ...
  virtual std::shared_ptr<Component<FunctionSpaceType, nComponentsValue>>
  component(int componentNo) = 0;
...
protected:
  ...
  std::array<std::string, nComponentsValue>
      componentNames_; //< names of the components, e.g. "x","y","z"
};
