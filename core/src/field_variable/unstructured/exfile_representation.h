...
public:
  ...
  getExfileElementRepresentation(element_no_t elementNo);
  ...
  //! remove redundant representation_ objects by changing the pointers such
  //! that the pointed to objects are unique
...
private:
  std::shared_ptr<ExfileElementRepresentation>
      currentElementRepresentation_; //< the most recent element indexing
