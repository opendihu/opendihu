...
void DiscretizableInTime<FunctionSpaceType, nComponentsSolutionVariable>::
  ...
  // no special component names here, this is e.g. overloaded in cellML adapter
  // where component names are available
}

template <typename FunctionSpaceType, int nComponentsSolutionVariable>
constexpr int DiscretizableInTime<FunctionSpaceType,
                                  nComponentsSolutionVariable>::nComponents() {
