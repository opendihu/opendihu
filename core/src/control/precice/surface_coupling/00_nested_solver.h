 ...
 * 
 *  This is an implementation for a nested structure where a MuscleContractionSolver is nested in one other solver:
 * 
 *   // actual simlation
 *  Control::PreciceAdapter<                  // surface coupling to tendons
 *    Control::PreciceAdapterVolumeCoupling<  // volume coupling to 3D bidomain and fibers
    ...
    public Runnable 
{
  ...
  typedef NestedSolver NestedSolverType;
