...
/** This class stores the times when different fibers are stimulated and output
 * them to a log file at the end.
 */
...
public:
  ...
  //! register the event of starting a stimulation for given motor unit, called
  //! by FastMonodomainSolver
  static void logStimulationBegin(double currentTime, int motorUnitNo,
                                  int fiberNo);
