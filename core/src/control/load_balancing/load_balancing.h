...
/** This is the load balancing class for any time stepping type, it does not
 * perform load balancing.
 */
template <typename TimeStepping>
class LoadBalancing : public LoadBalancingBase<TimeStepping> {
public:
...
class LoadBalancing<OperatorSplitting::Strang<
    TimeSteppingScheme::HeunAdaptive<CellMLAdapter>, DiffusionTimeStepping>>
    : public LoadBalancingBase<OperatorSplitting::Strang<
