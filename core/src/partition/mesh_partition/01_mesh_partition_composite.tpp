...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nElementsLocal() const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nElementsGlobal() const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nDofsLocalWithGhosts() const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nDofsLocalWithoutGhosts() const {
  const int nDofsPerNode =
      FunctionSpace::FunctionSpace<Mesh::StructuredDeformableOfDimension<D>,
                                   BasisFunctionType>::nDofsPerNode();
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nDofsGlobal() const {
  const int nDofsPerNode =
      FunctionSpace::FunctionSpace<Mesh::StructuredDeformableOfDimension<D>,
                                   BasisFunctionType>::nDofsPerNode();
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nDofsGlobalForBoundaryConditions()
    const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nNodesLocalWithGhosts() const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nNodesLocalWithoutGhosts() const {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::nNodesGlobal() const {
  return nNodesGlobal_;
}

template <int D, typename BasisFunctionType>
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::CompositeOfDimension<D>>::nNodesGlobal(int coordinateDirection)
    const {
  assert(nSubMeshes_ > 0);
  return subFunctionSpaces_[0]->nNodesGlobal(coordinateDirection);
}

//! get the number of nodes in the global Petsc ordering that are in partitions
//! prior to the own rank
template <int D, typename BasisFunctionType>
global_no_t
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::beginNodeGlobalPetsc() const {
  return nonDuplicateNodeNoGlobalBegin_;
}

//! returns the number of submeshes
template <int D, typename BasisFunctionType>
int MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                               BasisFunctionType>,
                  Mesh::CompositeOfDimension<D>>::nSubMeshes() const {
  return nSubMeshes_;
}
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::localToGlobalMappingDofs() {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  for (int subMeshIndex = 0; subMeshIndex < subMeshNo; subMeshIndex++) {
    elementNoGlobalNatural +=
        subFunctionSpaces_[subMeshIndex]->nElementsGlobal();
  }

  // add the elementNo in the current submesh
  elementNoGlobalNatural +=
      subFunctionSpaces_[subMeshNo]->meshPartition()->getElementNoGlobalNatural(
          elementOnMeshNoLocal);
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  node_no_t nodeNoLocal =
      subFunctionSpaces_[subMeshNo]->getNodeNo(elementOnMeshNoLocal, nodeIndex);

  // get global natural no on subMesh
  std::array<global_no_t, D> coordinatesGlobal =
      subFunctionSpaces_[subMeshNo]->meshPartition()->getCoordinatesGlobal(
          nodeNoLocal);
  global_no_t nodeNoGlobalNaturalSubMesh =
      subFunctionSpaces_[subMeshNo]->meshPartition()->getNodeNoGlobalNatural(
          coordinatesGlobal);
...
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::CompositeOfDimension<D>>::getNodeNoGlobalPetsc(node_no_t nodeNoLocal)
    const {
  std::pair<int, node_no_t> result =
      nodeNoNonDuplicateLocalToMeshAndDuplicateLocal_[nodeNoLocal];
...
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    getDofNoGlobalPetsc(const std::vector<dof_no_t> &dofNosLocal,
  ...
  PetscErrorCode ierr;
  ierr = ISLocalToGlobalMappingApply(localToGlobalPetscMappingDofs_,
                                     dofNosLocal.size(), dofNosLocal.data(),
                                     dofNosGlobalPetsc.data());
  CHKERRV(ierr);
}

//! get the global petsc dof no for the local no, using the PETSc localToGlobal
//! mapping for the dofs
template <int D, typename BasisFunctionType>
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::CompositeOfDimension<D>>::getDofNoGlobalPetsc(dof_no_t dofNoLocal)
    const {
  PetscInt dofNoGlobal;
  PetscErrorCode ierr;
  ierr = ISLocalToGlobalMappingApply(localToGlobalPetscMappingDofs_, 1,
                                     &dofNoLocal, &dofNoGlobal);
  CHKERRQ(ierr);
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::
    getElementNoLocal(global_no_t elementNoGlobalPetsc,
                      bool &isOnLocalDomain) const {
  if (elementNoGlobalBegin_ <= elementNoGlobalPetsc &&
      elementNoGlobalPetsc < elementNoGlobalBegin_ + nElementsLocal_) {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  node_no_t nodeNoLocal =
      (node_no_t)(nodeNoGlobalPetsc - nonDuplicateNodeNoGlobalBegin_);
...
//! nodes
template <int D, typename BasisFunctionType>
dof_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::CompositeOfDimension<D>>::getDofNoLocal(global_no_t dofNoGlobalPetsc,
                                                  bool &isLocal) const {
  const int nDofsPerNode =
      FunctionSpace::FunctionSpace<Mesh::StructuredDeformableOfDimension<D>,
                                   BasisFunctionType>::nDofsPerNode();
  ...
  return getNodeNoLocal(nodeNoGlobalPetsc, isLocal) * nDofsPerNode +
         nodalDofIndex;
}
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  return subFunctionSpaces_[0]
      ->meshPartition()
      ->getNodeNoLocalFromGlobalNatural(nodeNoGlobalNatural, isOnLocalDomain);
}
...
int MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  // call method of first sub mesh
  return subFunctionSpaces_[0]->meshPartition()->getRankOfNodeNoGlobalNatural(
      nodeNoGlobalNatural);
}
...
//! get a vector of global natural dof nos of the locally stored non-ghost dofs,
//! needed for setParameters callback function in cellml adapter
template <int D, typename BasisFunctionType>
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    getDofNosGlobalNatural(
        std::vector<global_no_t> &dofNosGlobalNatural) const {
  ...
  for (int subMeshNo = 0; subMeshNo < nSubMeshes_; subMeshNo++) {
    ...
    subFunctionSpaces_[subMeshNo]->meshPartition()->getDofNosGlobalNatural(
        dofNosGlobalNaturalSubMesh);
    ...
    for (node_no_t nodeNoLocal = 0;
      ...
      if (meshAndNodeNoLocalToNodeNoNonDuplicateGlobal_[subMeshNo]
                                                       [nodeNoLocal] != -1) {
        node_no_t nodeNoNonDuplicateLocal =
            meshAndNodeNoLocalToNodeNoNonDuplicateLocal_[subMeshNo]
                                                        [nodeNoLocal];

        for (int nodalDofIndex = 0; nodalDofIndex < nDofsPerNode;
             nodalDofIndex++) {
          dof_no_t dofNoNonDuplicateLocal =
              nodeNoNonDuplicateLocal * nDofsPerNode + nodalDofIndex;
          dofNosGlobalNatural[dofNoNonDuplicateLocal] =
              offset + dofNosGlobalNaturalSubMesh[nodeNoLocal * nDofsPerNode +
                                                  nodalDofIndex];
        }
      }
    }
...
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    extractLocalNodesWithoutGhosts(std::vector<T> &values,
                                   int nComponents) const {
  std::vector<T> result(nNodesLocalWithoutGhosts() * nComponents);

  LOG(DEBUG) << "extractLocalNodesWithoutGhosts, initialize result with size "
             << result.size()
  ...
  for (int subMeshNo = 0; subMeshNo < nSubMeshes_; subMeshNo++) {
    ...
    for (node_no_t nodeNoLocal = 0;
      ...
      if (meshAndNodeNoLocalToNodeNoNonDuplicateGlobal_[subMeshNo]
                                                       [nodeNoLocal] != -1) {
        // get the global number of the composite numbering that maps to the
        // current node
        global_no_t nodeNoNonDuplicateGlobal =
            meshAndNodeNoLocalToNodeNoNonDuplicateGlobal_[subMeshNo]
                                                         [nodeNoLocal];

        // copy the value from the input vector at the global no location to the
        // local location in the result vector
        for (int componentNo = 0; componentNo < nComponents; componentNo++) {
          assert(nodeNoNonDuplicateGlobal * nComponents + componentNo <
                 values.size());

          result[nodeNoLocal * nComponents + componentNo] =
              values[nodeNoNonDuplicateGlobal * nComponents + componentNo];
        }
      }
    }
  }
...
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  LOG(DEBUG) << "extractLocalDofsWithoutGhosts, initialize result with size "
             << result.size()
             << " (nNodesLocalWithoutGhosts: " << nNodesLocalWithoutGhosts()
  ...
  for (int subMeshNo = 0; subMeshNo < nSubMeshes_; subMeshNo++) {
    ...
    for (node_no_t nodeNoLocal = 0;
         ...
         subFunctionSpaces_[subMeshNo]->nNodesLocalWithoutGhosts();
         nodeNoLocal++) {
      assert(meshAndNodeNoLocalToNodeNoNonDuplicateGlobal_[subMeshNo].size() >
             nodeNoLocal);
      ...
      if (meshAndNodeNoLocalToNodeNoNonDuplicateGlobal_[subMeshNo]
        ...
        for (int nodalDofIndex = 0; nodalDofIndex < nDofsPerNode;
          ...
          global_no_t dofNoNonDuplicateGlobal =
              nodeNoNonDuplicateGlobal * nDofsPerNode + nodalDofIndex;
...
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::output(std::ostream
                                                              &stream) {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::dofNosLocal(bool onlyNodalValues)
    const {
  if (onlyNodalValues) {
...
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
              Mesh::CompositeOfDimension<D>>::ghostDofNosGlobalPetsc() const {
...
bool MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::CompositeOfDimension<D>>::isNonGhost(node_no_t nodeNoLocal,
                                               int &neighbourRankNo) const {
  std::vector<std::pair<int, node_no_t>> subMeshesWithNodes;
  getSubMeshesWithNodes(nodeNoLocal, subMeshesWithNodes);

  VLOG(2) << "isNonGhost, nodeNoLocal: " << nodeNoLocal
          << ", subMeshesWithNodes (submesh no, node no in that submesh): "
          << subMeshesWithNodes;
  ...
  for (const std::pair<int, node_no_t> &subMeshWithNodes : subMeshesWithNodes) {
    ...
    if (subFunctionSpaces_[subMeshNo]->meshPartition()->isNonGhost(
            nodeNoLocalOnMesh, neighbourRankNo)) {
      VLOG(2) << "yes, isNonGhost on submesh " << subMeshNo
              << " (local node no " << nodeNoLocalOnMesh << ") on rank "
              << neighbourRankNo;
  ...
  subFunctionSpaces_[subMeshNo]->meshPartition()->isNonGhost(nodeNoLocalOnMesh,
                                                             neighbourRankNo);

  VLOG(2) << "isNonGhost, nodeNoLocal: " << nodeNoLocal
          << ", subMeshesWithNodes: " << subMeshesWithNodes;
  VLOG(2) << "  -> is ghost, subMeshNo: " << subMeshNo
          << ", nodeNoLocalOnMesh: " << nodeNoLocalOnMesh
          << ", neighbourRankNo: " << neighbourRankNo;

  return false;
}

//! get information about neighbouring rank and boundary elements for specified
//! face,
//! @param neighbourRankNo: the rank of the neighbouring process that shares the
//! face, @param nElements: Size of one-layer mesh that contains boundary
//! elements that touch the neighbouring process
template <int D, typename BasisFunctionType>
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    getBoundaryElements(Mesh::face_t face, int &neighbourRankNo,
  ...
  LOG(FATAL)
      << "\"getBoundaryElements\" is not implemented for composite mesh.";
}
...
int MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                               BasisFunctionType>,
                  Mesh::CompositeOfDimension<D>>::neighbourRank(Mesh::face_t
                                                                    face) {
  // This method is only needed for parallel fiber estimation
...
//! from a local node no in the composite numbering get the subMeshNo and the no
//! in the submesh-based numbering
template <int D, typename BasisFunctionType>
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    getSubMeshNoAndNodeNoLocal(node_no_t nodeNoLocal, int &subMeshNo,
                               node_no_t &nodeOnMeshNoLocal) const {
  // loop over submeshes
  node_no_t nNodesPreviousSubMeshes = 0;
  for (int subMeshIndex = 0; subMeshIndex < nSubMeshes_; subMeshIndex++) {
    node_no_t nNodesCurrentSubMesh =
        nNonDuplicateNodesWithoutGhosts_[subMeshIndex];
    VLOG(2) << "submesh " << subMeshIndex << " has " << nNodesCurrentSubMesh
            << " nodes, nNodesPreviousSubMeshes: " << nNodesPreviousSubMeshes;
    ...
    if (nodeNoLocal < nNodesPreviousSubMeshes + nNodesCurrentSubMesh) {
      ...
      node_no_t nodeNoCompositeOnMeshNoLocal =
          nodeNoLocal - nNodesPreviousSubMeshes;

      nodeOnMeshNoLocal = nodeNoCompositeOnMeshNoLocal;

      for (node_no_t nodeNo = 0; nodeNo <= nodeOnMeshNoLocal; nodeNo++) {
        // if node is removed
        if (removedSharedNodes_[subMeshIndex].find(nodeNo) !=
            removedSharedNodes_[subMeshIndex].end()) {
          nodeOnMeshNoLocal++;
        }
      }
  ...
  for (int subMeshIndex = 0; subMeshIndex < nSubMeshes_; subMeshIndex++) {
    node_no_t nGhostNodesCurrentSubMesh =
        nNonDuplicateGhostNodes_[subMeshIndex];
    VLOG(2) << "submesh " << subMeshIndex << " has "
            << nGhostNodesCurrentSubMesh
            << " ghost nodes, nNodesPreviousSubMeshes: "
            << nNodesPreviousSubMeshes;
    ...
    if (nodeNoLocal < nNodesPreviousSubMeshes + nGhostNodesCurrentSubMesh) {
      ...
      // nRemovedNodesNonGhost_[subMeshNo];
      nodeOnMeshNoLocal = nodeNoLocal - nNodesPreviousSubMeshes +
                          nNonDuplicateNodesWithoutGhosts_[subMeshNo] +
                          nRemovedNodesNonGhost_[subMeshNo];

      // LOG(DEBUG) << "nodeOnMeshNoLocal = " << nodeNoLocal << " - " <<
      // nNodesPreviousSubMeshes << " + " << nRemovedNodesNonGhost_[subMeshNo]
      // << " = " << nodeOnMeshNoLocal;
      VLOG(2) << "nodeOnMeshNoLocal = " << nodeNoLocal << " - "
              << nNodesPreviousSubMeshes << " + "
              << nNonDuplicateNodesWithoutGhosts_[subMeshNo] << " + "
              << nRemovedNodesNonGhost_[subMeshNo] << " = "
              << nodeOnMeshNoLocal;
      VLOG(2) << "nNonDuplicateNodesWithoutGhosts_: "
              << nNonDuplicateNodesWithoutGhosts_
              << ", nRemovedNodesNonGhost_: " << nRemovedNodesNonGhost_;
      break;
    }
...
//! from a local element no in the composite numbering get the subMeshNo and the
//! no in the submesh-based numbering
template <int D, typename BasisFunctionType>
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                                BasisFunctionType>,
                   Mesh::CompositeOfDimension<D>>::
    getSubMeshNoAndElementNoLocal(element_no_t elementNoLocal, int &subMeshNo,
  ...
  for (int subMeshIndex = 0; subMeshIndex < nSubMeshes_; subMeshIndex++) {
    element_no_t nElementsLocal =
        subFunctionSpaces_[subMeshIndex]->nElementsLocal();

    if (elementNoLocal >= nElementsPreviousSubMeshes &&
        elementNoLocal < nElementsPreviousSubMeshes + nElementsLocal) {
      subMeshNo = subMeshIndex;
...
void MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
  ...
  VLOG(1) << "node local " << nodeNoLocal << " is node local "
          << nodeOnMeshNoLocal << " on sub mesh " << subMeshNo;

  subMeshesWithNodes.push_back(std::make_pair(subMeshNo, nodeOnMeshNoLocal));

  // loop over all meshes and shared nodes
  for (int subMeshIndex = 0; subMeshIndex < nSubMeshes_; subMeshIndex++) {
    for (std::map<node_no_t, std::pair<int, node_no_t>>::const_iterator iter =
             removedSharedNodes_[subMeshIndex].begin();
      ...
      if (meshNoOtherMesh == subMeshNo &&
          nodeNoOnOtherMesh == nodeOnMeshNoLocal) {
...
//! local node no in the composite numbering
template <int D, typename BasisFunctionType>
node_no_t
MeshPartition<FunctionSpace::FunctionSpace<Mesh::CompositeOfDimension<D>,
                                           BasisFunctionType>,
  ...
  assert(subMeshNo >= 0 &&
         subMeshNo < meshAndNodeNoLocalToNodeNoNonDuplicateLocal_.size());
  assert(nodeNoDuplicateOnSubmesh >= 0 &&
         nodeNoDuplicateOnSubmesh <
             meshAndNodeNoLocalToNodeNoNonDuplicateLocal_[subMeshNo].size());

  nodeIsSharedAndRemovedInCurrentMesh =
      isDuplicate_[subMeshNo][nodeNoDuplicateOnSubmesh];

  // std::vector<std::map<node_no_t,std::pair<int,node_no_t>>>
  // removedSharedNodes_;   //< removedSharedNodes_[meshNo][nodeNo] =
  // <sameAsInMeshNo,nodeNoOfThatMesh> nodes that are shared between function
  // spaces, they appear only once in the second function space and are removed
  // there (not included in the composite mapping)

  // if the node on the mesh subMeshNo is a duplicate node and therefore its
  // entry in meshAndNodeNoLocalToNodeNoNonDuplicateLocal_ is -1
  if (nodeIsSharedAndRemovedInCurrentMesh) {
    // get the same shared node in the other mesh that has its entry in
    // meshAndNodeNoLocalToNodeNoNonDuplicateLocal_
    std::pair<int, node_no_t> sharedNode =
        removedSharedNodes_[subMeshNo].at(nodeNoDuplicateOnSubmesh);

    // use this entry
    return meshAndNodeNoLocalToNodeNoNonDuplicateLocal_[sharedNode.first]
                                                       [sharedNode.second];
  }

  // node is a normal, non-shared node
  return meshAndNodeNoLocalToNodeNoNonDuplicateLocal_[subMeshNo]
                                                     [nodeNoDuplicateOnSubmesh];
}
