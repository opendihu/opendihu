...
std::array<global_no_t, MeshType::dim()> MeshPartition<
    FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
    Mesh::isStructured<MeshType>>::getCoordinatesGlobal(node_no_t nodeNoLocal)
    const {
  if (nNodesLocalWithoutGhosts() == 0)
    return std::array<global_no_t, MeshType::dim()>({0});

  if (MeshType::dim() == 1) {
    return std::array<global_no_t, MeshType::dim()>(
        {beginNodeGlobalNatural(0) + nodeNoLocal});
  } else if (MeshType::dim() == 2) {
    std::array<global_no_t, MeshType::dim()> coordinates;
    if (nodeNoLocal < nNodesLocalWithoutGhosts()) {
      coordinates[0] =
          beginNodeGlobalNatural(0) + nodeNoLocal % nNodesLocalWithoutGhosts(0);
      coordinates[1] =
          beginNodeGlobalNatural(1) + nodeNoLocal / nNodesLocalWithoutGhosts(0);
    } else {
      if (hasFullNumberOfNodes(0)) {
        if (hasFullNumberOfNodes(1)) {
          ...
          coordinates[1] =
              beginNodeGlobalNatural(1) + nNodesLocalWithGhosts(1) - 1;
        }
      } else {
        if (hasFullNumberOfNodes(1)) {
          ...
          global_no_t ghostNo = nodeNoLocal - nNodesLocalWithoutGhosts();
          coordinates[0] =
              beginNodeGlobalNatural(0) + nNodesLocalWithGhosts(0) - 1;
          coordinates[1] = beginNodeGlobalNatural(1) + ghostNo;
        } else {
          // domain has right and top ghost nodes
          if (nodeNoLocal <
              nNodesLocalWithoutGhosts() + nNodesLocalWithoutGhosts(1)) {
    ...
    if (nodeNoLocal < nNodesLocalWithoutGhosts()) {
      coordinates[0] =
          beginNodeGlobalNatural(0) + nodeNoLocal % nNodesLocalWithoutGhosts(0);
      coordinates[1] = beginNodeGlobalNatural(1) +
                       (nodeNoLocal % (nNodesLocalWithoutGhosts(0) *
                                       nNodesLocalWithoutGhosts(1))) /
                           nNodesLocalWithoutGhosts(0);
      coordinates[2] = beginNodeGlobalNatural(2) +
                       nodeNoLocal / (nNodesLocalWithoutGhosts(0) *
                                      nNodesLocalWithoutGhosts(1));
    } else {
      if (hasFullNumberOfNodes(0)) {
        if (hasFullNumberOfNodes(1)) {
          if (hasFullNumberOfNodes(2)) {
            ...
            LOG(ERROR) << "degenerate mesh partition: "
                       << nNodesLocalWithoutGhosts() << " local nodes";
            ...
            coordinates[0] =
                beginNodeGlobalNatural(0) + ghostNo % nNodesLocalWithGhosts(0);
            coordinates[1] =
                beginNodeGlobalNatural(1) + ghostNo / nNodesLocalWithGhosts(0);
            coordinates[2] =
                beginNodeGlobalNatural(2) + nNodesLocalWithGhosts(2) - 1;
          }
        } else {
          if (hasFullNumberOfNodes(2)) {
            ...
            coordinates[1] =
                beginNodeGlobalNatural(1) + nNodesLocalWithGhosts(1) - 1;
            coordinates[2] =
                beginNodeGlobalNatural(2) + ghostNo / nNodesLocalWithGhosts(0);
          } else {
            ...
            if (nodeNoLocal <
              ...
              global_no_t ghostNo = nodeNoLocal - nNodesLocalWithoutGhosts();
              coordinates[0] = beginNodeGlobalNatural(0) +
                               ghostNo % nNodesLocalWithoutGhosts(0);
              coordinates[1] =
                  beginNodeGlobalNatural(1) + nNodesLocalWithGhosts(1) - 1;
              coordinates[2] = beginNodeGlobalNatural(2) +
                               ghostNo / nNodesLocalWithoutGhosts(0);
              ...
              global_no_t ghostNo =
                  nodeNoLocal - nNodesLocalWithoutGhosts() -
                  nNodesLocalWithoutGhosts(0) * nNodesLocalWithoutGhosts(2);
              coordinates[0] = beginNodeGlobalNatural(0) +
                               ghostNo % nNodesLocalWithoutGhosts(0);
              coordinates[1] = beginNodeGlobalNatural(1) +
        ...
        if (hasFullNumberOfNodes(1)) {
          if (hasFullNumberOfNodes(2)) {
            ...
            coordinates[0] =
                beginNodeGlobalNatural(0) + nNodesLocalWithGhosts(0) - 1;
            coordinates[1] = beginNodeGlobalNatural(1) +
                             ghostNo % nNodesLocalWithoutGhosts(1);
            coordinates[2] = beginNodeGlobalNatural(2) +
                             ghostNo / nNodesLocalWithoutGhosts(1);
          } else {
            ...
            if (nodeNoLocal <
              ...
              global_no_t ghostNo =
                  ...
                  nNodesLocalWithoutGhosts(1) * nNodesLocalWithoutGhosts(2);
              coordinates[0] = beginNodeGlobalNatural(0) +
                               ghostNo % nNodesLocalWithGhosts(0);
              coordinates[1] = beginNodeGlobalNatural(1) +
                               ghostNo / nNodesLocalWithGhosts(0);
              coordinates[2] =
                  beginNodeGlobalNatural(2) + nNodesLocalWithGhosts(2) - 1;
          ...
          if (hasFullNumberOfNodes(2)) {
            ...
            global_no_t ghostNo = nodeNoLocal - nNodesLocalWithoutGhosts();
            global_no_t nNodesPerL =
                (nNodesLocalWithoutGhosts(1) + nNodesLocalWithGhosts(0));
            ...
            if (ghostOnZPlaneNo < nNodesLocalWithoutGhosts(1)) {
              ...
              global_no_t ghostNoOnYPlane =
                  ghostOnZPlaneNo - nNodesLocalWithoutGhosts(1);
            ...
            if (ghostNo >= nNodesPerL * nNodesLocalWithoutGhosts(2)) {
              ...
              if (ghostOnLNo < nNodesLocalWithoutGhosts(1)) {
                ...
                coordinates[2] =
                    beginNodeGlobalNatural(2) + ghostNo / nNodesPerL;
              } else {
                // ghost node is on back (y+) plane
                global_no_t ghostNoOnYPlane =
                    ghostOnLNo - nNodesLocalWithoutGhosts(1);
                coordinates[0] = beginNodeGlobalNatural(0) + ghostNoOnYPlane;
                coordinates[1] =
                    beginNodeGlobalNatural(1) + nNodesLocalWithGhosts(1) - 1;
                coordinates[2] =
  ...
  return std::array<global_no_t, MeshType::dim()>(
      {0}); // this never happens, but the intel compiler does not recognize it
            // (gcc does)
}

template <typename MeshType, typename BasisFunctionType>
std::array<int, MeshType::dim()> MeshPartition<
    FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
    Mesh::isStructured<MeshType>>::getCoordinatesLocal(node_no_t nodeNoLocal)
    const {
  if (nNodesLocalWithoutGhosts() == 0)
...
MeshPartition<FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
  ...
  for (int coordinateDirection = 0; coordinateDirection < D;
       coordinateDirection++) {
    coordinatesLocal[coordinateDirection] =
        coordinatesGlobal[coordinateDirection] -
        this->beginNodeGlobalNatural(coordinateDirection);

    // check if the computed local coordinate is in the local range of nodes
    if (coordinatesLocal[coordinateDirection] < 0 ||
        coordinatesLocal[coordinateDirection] >=
            nNodesLocalWithoutGhosts(coordinateDirection)) {
...
MeshPartition<FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
  ...
  if (MeshType::dim() == 1) {
    ...
    result[1] =
        int((elementNoLocal % (nElementsLocal_[0] * nElementsLocal_[1])) /
            nElementsLocal_[0]);
    result[0] = elementNoLocal % nElementsLocal_[0];
  } else {
    assert(false);
...
MeshPartition<FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
  ...
  if (MeshType::dim() == 1) {
    ...
    coordinatesGlobal[0] = nodeNoGlobalNatural % nNodesGlobal(0);
    coordinatesGlobal[1] =
        (nodeNoGlobalNatural % (nNodesGlobal(0) * nNodesGlobal(1))) /
        nNodesGlobal(0);
    coordinatesGlobal[2] =
        nodeNoGlobalNatural / (nNodesGlobal(0) * nNodesGlobal(1));
  }
...
MeshPartition<FunctionSpace::FunctionSpace<MeshType, BasisFunctionType>,
  ...
  if (MeshType::dim() == 1) {
    ...
    // VLOG(3) << "getNodeNo(" << coordinatesLocal << "),
    // nNodesLocalWithoutGhosts: " << nNodesLocalWithoutGhosts()
    //   << ", nNodesLocalWithoutGhosts: (" << nNodesLocalWithoutGhosts(0) <<
    //   "," << nNodesLocalWithoutGhosts(1) << ")";
    ...
    if (localX == nNodesLocalWithoutGhosts(0)) // point is on right ghost row
    {
      ...
      if (localY == nNodesLocalWithoutGhosts(1)) // point is on top ghost row
      {
        ...
        if (hasFullNumberOfNodes(0)) {
          ...
          // VLOG(3) << "  d: " << nNodesLocalWithoutGhosts() +
          // nNodesLocalWithoutGhosts(1) + localX;
          return nNodesLocalWithoutGhosts() + nNodesLocalWithoutGhosts(1) +
                 localX;
        }
      } else {
        // point is in interior
        // VLOG(3) << " e: " << nNodesLocalWithoutGhosts() +
    ...
    /*VLOG(3) << "getNodeNo(" << coordinatesLocal << "),
      ...
      << nNodesLocalWithoutGhosts(1) << "," << nNodesLocalWithoutGhosts(2) <<
      ")"
      << ", hasFullNumberOfNodes: (" << hasFullNumberOfNodes(0) << "," <<
      hasFullNumberOfNodes(1) << "," << hasFullNumberOfNodes(2) << ")";*/
    ...
    if (localZ == nNodesLocalWithoutGhosts(2)) // point is on top ghost row
    {
      ...
      } else // there are ghosts at y+
      {
        ...
        } else // there are ghosts at x+
        {
          ...
          const int nNodesPerL =
              nNodesLocalWithoutGhosts(0) + nNodesLocalWithGhosts(1);
          return nNodesLocalWithoutGhosts() +
               ...
               nNodesLocalWithoutGhosts(0)) // point is on right ghost row (x+)
    {
      if (hasFullNumberOfNodes(1)) // there is no ghosts at y+
      {
      ...
      } else // there are ghosts at y+
      {
        const int nNodesPerL =
            nNodesLocalWithoutGhosts(0) + nNodesLocalWithGhosts(1);
        if (localY ==
            nNodesLocalWithoutGhosts(1)) // point is on back ghost row (y+)
        {
          // ghost is at right back vertical edge
          return nNodesLocalWithoutGhosts() + nNodesPerL * localZ +
                 nNodesLocalWithoutGhosts(1) + nNodesLocalWithoutGhosts(0);
        } else {
          // there are ghosts at x+ and y+
          return nNodesLocalWithoutGhosts() + nNodesPerL * localZ + localY;
        }
      }
    } else if (localY ==
               nNodesLocalWithoutGhosts(1)) // point is on back ghost row (y+)
    {
      ...
      return nNodesLocalWithoutGhosts(0) * nNodesLocalWithoutGhosts(1) *
                 localZ +
             nNodesLocalWithoutGhosts(0) * localY + localX;
    }
  }
