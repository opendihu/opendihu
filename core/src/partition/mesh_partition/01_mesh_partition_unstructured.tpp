...
MeshPartition<
    ...
    MeshPartition(global_no_t nElementsGlobal, global_no_t nNodesGlobal,
                  global_no_t nDofsGlobal,
                  std::shared_ptr<RankSubset> rankSubset)
    : MeshPartitionBase(rankSubset), nElements_(nElementsGlobal),
      nNodes_(nNodesGlobal), nDofs_(nDofsGlobal) {
...
template <int D, typename BasisFunctionType>
ISLocalToGlobalMapping MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::localToGlobalMappingDofs() {
  PetscErrorCode ierr;
  ...
  ierr = ISLocalToGlobalMappingCreate(mpiCommunicator(), 1, nDofs_,
                                      globalDofNos.data(), PETSC_COPY_VALUES,
...
element_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nElementsLocal() const {
  return nElements_;
}
...
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nElementsGlobal() const {
  return nElements_;
}
...
node_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nNodesLocalWithGhosts() const {
  return nNodes_;
}
...
dof_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nDofsLocalWithGhosts() const {
  return nDofs_;
}
...
dof_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nDofsLocalWithoutGhosts()
    const {
  return nDofs_;
}
...
node_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nNodesLocalWithoutGhosts()
    const {
  return nNodes_;
}
...
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nNodesGlobal() const {
  return nNodes_;
}
...
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nDofs() const {
  return nDofs_;
}
...
global_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::nDofsGlobal() const {
  return nDofs_;
}
...
template <int D, typename BasisFunctionType>
std::array<int, D> MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::
    getCoordinatesLocal(std::array<global_no_t, D> coordinatesGlobal,
                        bool &isOnLocalDomain) const {
  // because we have no parallel execution, global coordinates are the same as
  // local coordinates and isOnLocalDomain is always true
  isOnLocalDomain = true;
  std::array<int, D> coordinatesLocal(coordinatesGlobal.begin(),
                                      coordinatesGlobal.end());
...
node_no_t MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::
    getNodeNoLocal(std::array<global_no_t, D> coordinatesGlobal,
                   bool &isOnLocalDomain) const {
...
void MeshPartition<
    FunctionSpace::FunctionSpace<Mesh::UnstructuredDeformableOfDimension<D>,
                                 BasisFunctionType>,
    Mesh::UnstructuredDeformableOfDimension<D>>::output(std::ostream &stream) {
  stream << "MeshPartition<Unstructured>, nElements_: " << nElements_
         << ", nNodes_: " << nNodes_ << ", nDofs_: " << nDofs_;
}
