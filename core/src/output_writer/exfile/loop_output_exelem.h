 ...
 *
 *  Call ExfileWriter::outputExelem on the mesh with meshName. This outputs all
 * field variables of the mesh to an exelem file.
 */
...
loopOutputExelem(const FieldVariablesForOutputWriterType &fieldVariables,
