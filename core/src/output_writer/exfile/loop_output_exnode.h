 ...
 *
 *  Call ExfileWriter::outputExnode on the mesh with meshName. This outputs all
 * field variables of the mesh to an exnode file.
 */
...
loopOutputExnode(const FieldVariablesForOutputWriterType &fieldVariables,
