...
void Json::writeCombinedUnstructuredGridFile(
  ...
  if (!meshPropertiesInitialized) {
    Control::PerformanceMeasurement::start("durationJson3DInit");
  ...
  if (!meshPropertiesInitialized) {
    Control::PerformanceMeasurement::start("durationJson2D3DInit");
    ...
    Control::PerformanceMeasurement::stop("durationJson2D3DInit");
  }
  ...
  for (std::pair<const std::string, PolyDataPropertiesForMesh> &props :
    ...
    JsonUtils::Group group2 = group.newGroup(props.first.c_str());
...
void Json::writeCombinedUnstructuredGridFile(
  ...
  if (!meshPropertiesInitialized) {
    ...
    Control::PerformanceMeasurement::start("durationJson3DInit");
    Control::PerformanceMeasurement::start("durationJson3DReduction");
    ...
    Control::PerformanceMeasurement::stop("durationJson3DReduction");
    Control::PerformanceMeasurement::stop("durationJson3DInit");
  } else {
  ...
  Control::PerformanceMeasurement::start("durationJson3DWrite");
  ...
  writeCombinedTypesVector(group, polyDataPropertiesForMesh.nCellsGlobal,
                           output3DMeshes, "types");

  Control::PerformanceMeasurement::stop("durationJson3DWrite");
}
} // namespace OutputWriter
