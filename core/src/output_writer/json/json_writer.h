...
/** Base class of JsonWriter that writes vtk files of given field variables.
...
public:
  ...
  static void outputFile(JsonUtils::Group &group,
...
public:
  ...
  static void outputFile(
      JsonUtils::Group &group, FieldVariablesForOutputWriterType fieldVariables,
      const std::string &meshName,
...
#include "output_writer/json/json_writer.tpp"
