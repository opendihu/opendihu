...
PythonFile::PythonFile(DihuContext context, PythonConfig settings,
...
PyObject *PythonFile::openPythonFileStream(std::string filename,
  ...
  // PyObject *file = PyFile_FromFd(fileDescriptorC, NULL, "w", -1, NULL, NULL,
  // NULL, true);
  ...
  PyObject *file = PyObject_CallMethod(ioModule, "open", "ss", filename.c_str(),
                                       writeFlag.c_str());
  Py_XDECREF(ioModule);
