...
/** Writes a "*.vtk.series" JSON file that contains all written files and their
 *timestamps. This is the way to tell paraview about different files at specific
 *time steps. Example for such a file:
 * {
