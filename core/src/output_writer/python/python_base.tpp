...
PyObject *
PythonBase<FieldVariablesForOutputWriterType>::buildPyFieldVariablesObject(
    FieldVariablesForOutputWriterType fieldVariables, std::string meshName,
  ...
  VLOG(2) << "buildPyFieldVariablesObject for " << nFieldVariablesInMesh
          << " field variables: "
  ...
  PythonLoopOverTuple::loopBuildPyFieldVariableObject<
      FieldVariablesForOutputWriterType>(fieldVariables, fieldVariableIndex,
                                         meshName, pyData, onlyNodalValues,
                                         mesh);
