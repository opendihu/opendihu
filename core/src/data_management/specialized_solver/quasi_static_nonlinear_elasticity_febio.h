...
/**  The datastructures for the febio adapter where febio computes a static
...
public:
  ...
  typedef FieldVariable::FieldVariable<FunctionSpace, 3>
      FieldVariableTypeVector;
  typedef FieldVariable::FieldVariable<FunctionSpace, 6>
      FieldVariableTypeTensor;

  typedef SlotConnectorData<FunctionSpace, 1> SlotConnectorDataType;
...
private:
  ...
  std::shared_ptr<FieldVariableType>
      activation_; //< field variable of the activation factor field
  std::shared_ptr<FieldVariableTypeVector>
      referenceGeometry_; //< field variable of the geometry value
  std::shared_ptr<FieldVariableTypeVector>
      displacements_; //< field variable of the displacements
  std::shared_ptr<FieldVariableTypeVector>
      reactionForce_; //< field variable of the reaction forces
  std::shared_ptr<FieldVariableTypeTensor>
      pk2Stress_; //< field variable of the 2nd Piola-Kirchhoff stress, S
  std::shared_ptr<FieldVariableTypeTensor>
      cauchyStress_; //< field variable of the Cauchy stress, sigma
  std::shared_ptr<FieldVariableTypeTensor>
