...
class MyNewStaticSolver : public Data<FunctionSpaceType> {
public:
...
private:
  ...
  std::shared_ptr<ScalarFieldVariableType>
      solution_; //< the solution of the laplace problem
  std::shared_ptr<ScalarFieldVariableType>
...
#include "data_management/specialized_solver/my_new_static_solver.tpp"
