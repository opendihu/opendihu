...
class DynamicHyperelasticitySolver : public Data<FunctionSpaceType> {
public:
  ...
  //! variables. For each field variable you can transfer an abritrary subset of
  //! their components.
...
protected:
  ...
  std::shared_ptr<DisplacementsFieldVariableType>
      displacements_; //< the displacements, u
  std::shared_ptr<DisplacementsFieldVariableType>
      velocities_; //< v, the velocities
  std::shared_ptr<DisplacementsFieldVariableType>
      internalVirtualWork_; //< ∂Wint_stress
  std::shared_ptr<DisplacementsFieldVariableType>
      accelerationTerm_; //< ∂Wint_acceleration
  std::shared_ptr<DisplacementsFieldVariableType>
      externalVirtualWorkDead_; //< ∂Wext_dead
};
