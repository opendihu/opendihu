...
MultidomainWithFat<FunctionSpaceType, FunctionSpaceFatType>::MultidomainWithFat(
    DihuContext context)
...
template <typename FunctionSpaceType, typename FunctionSpaceFatType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceFatType, 1>>
MultidomainWithFat<FunctionSpaceType,
                   FunctionSpaceFatType>::extraCellularPotentialFat() {
  return this->extraCellularPotentialFat_;
}

template <typename FunctionSpaceType, typename FunctionSpaceFatType>
typename MultidomainWithFat<FunctionSpaceType,
                            FunctionSpaceFatType>::FieldVariablesForOutputWriter
MultidomainWithFat<FunctionSpaceType,
                   FunctionSpaceFatType>::getFieldVariablesForOutputWriter() {
  // these field variables will be written to output files
  std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceFatType, 3>>
      geometryFieldFat = std::make_shared<
          FieldVariable::FieldVariable<FunctionSpaceFatType, 3>>(
          this->functionSpace_->geometryField());

  LOG(DEBUG)
      << "getFieldVariablesForOutputWriter: this->extraCellularPotentialFat_: "
      << *this->extraCellularPotentialFat_;
