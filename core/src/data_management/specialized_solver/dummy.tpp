...
Dummy<FunctionSpaceType>::Dummy(DihuContext context)
    : Data<FunctionSpaceType>::Data(context) {}

template <typename FunctionSpaceType>
void Dummy<FunctionSpaceType>::initialize() {
...
template <typename FunctionSpaceType>
void Dummy<FunctionSpaceType>::createPetscObjects() {
  // no field variables are created
}

template <typename FunctionSpaceType>
std::shared_ptr<typename Dummy<FunctionSpaceType>::SlotConnectorDataType>
Dummy<FunctionSpaceType>::getSlotConnectorData() {
