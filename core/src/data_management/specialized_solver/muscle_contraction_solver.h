...
public:
  ...
  typedef FieldVariable::FieldVariable<FunctionSpaceType, 6>
      StressFieldVariableType; // stress tensor in Voigt notation
...
private:
  ...
  std::shared_ptr<ScalarFieldVariableType>
      lambda_; //< the relative sarcomere length
  std::shared_ptr<ScalarFieldVariableType>
      lambdaDot_; //< the contraction velocity
  std::shared_ptr<ScalarFieldVariableType>
      gamma_; //< the active stress parameter

  std::shared_ptr<VectorFieldVariableType>
      displacements_;                                   //< u, the displacements
