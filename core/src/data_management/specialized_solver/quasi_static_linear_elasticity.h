...
public:
  ...
  typedef FieldVariable::FieldVariable<FunctionSpaceType, 9>
...
private:
  ...
  std::shared_ptr<DataLinearElasticityType>
      dataLinearElasticity_; //< data object of the linear elasticity data class
