...
TimeSteppingReduced<functionSpaceRowsType>::TimeSteppingReduced(
    DihuContext context)
...
template <typename functionSpaceRowsType>
void TimeSteppingReduced<functionSpaceRowsType>::setFunctionSpaceRows(
    std::shared_ptr<functionSpaceRowsType> functionSpace) {
  this->functionSpaceRows_ = functionSpace;
}

template <typename functionSpaceRowsType>
std::shared_ptr<
    PartitionedPetscMat<functionSpaceRowsType, ::FunctionSpace::Generic>> &
TimeSteppingReduced<functionSpaceRowsType>::basis() {
  return this->basis_;
}

template <typename functionSpaceRowsType>
std::shared_ptr<
    PartitionedPetscMat<::FunctionSpace::Generic, functionSpaceRowsType>> &
TimeSteppingReduced<functionSpaceRowsType>::basisTransp() {
...
TimeSteppingReduced<functionSpaceRowsType>::redSysMatrix() {
  return this->redSysMatrix_;
}

template <typename functionSpaceRowsType>
void TimeSteppingReduced<functionSpaceRowsType>::initialize() {
  if (!this->initialized_) {
    this->createPetscObjects();
    this->initialized_ = true;
  } else {
    LOG(WARNING) << "TimeSteppingReduced::Initialize(), TimeSteppingReduced is "
                    "already assigned";
  }
}
...
template <typename functionSpaceRowsType>
std::shared_ptr<
    typename TimeSteppingReduced<functionSpaceRowsType>::FieldVariableType> &
TimeSteppingReduced<functionSpaceRowsType>::redSolution() {
  return redSolution_;
}
...
std::shared_ptr<
    typename TimeSteppingReduced<functionSpaceRowsType>::FieldVariableType> &
TimeSteppingReduced<functionSpaceRowsType>::redIncrement() {
  return redIncrement_;
}

template <typename functionSpaceRowsType>
void TimeSteppingReduced<functionSpaceRowsType>::createPetscObjects() {
  ...
  this->basis_ = std::make_shared<
      PartitionedPetscMat<::FunctionSpace::Generic, functionSpaceRowsType>>(
      meshPartitionRows, meshPartitionColumns, 1, "basis");
  this->basisTransp_ = std::make_shared<
      PartitionedPetscMat<::FunctionSpace::Generic, functionSpaceRowsType>>(
