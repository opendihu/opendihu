...
public:
  typedef LagrangeOfOrder<1>
      BasisFunctionUsingOnlyNodalValues; //< the same basis function, but only
                                         // using nodal values, for Hermite this
                                         // is the linear Lagrange functions.
                                         // This construct is used for Neumann
                                         // BC, where the integration over the
                                         // surface/line is done using Lagrange
                                         // ansatz functions.
