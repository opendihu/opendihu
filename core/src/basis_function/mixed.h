...
/* class that holds the two basisfunctions for mixed formulation for solid
 * mechanics
 */
template <typename LowOrderBasisFunctionType,
          typename HighOrderBasisFunctionType>
class Mixed {
public:
...
using isNotMixed =
    std::enable_if_t<!BasisFunctionType::isMixed, BasisFunctionType>;
