...
/**
 * A coupling between two time stepping schemes is the same as a Godunov
 * operator splitting. This class implements the functionality of both, the
 * classes Control::Coupling and OperatorSplitting::Godunov inherit from this
 * class.
 */
