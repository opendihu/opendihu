...
void CouplingOrGodunov<TimeStepping1, TimeStepping2>::advanceTimeSpan(
  ...
  for (; timeStepNo < this->numberTimeSteps_;) {
    ...
    {
      LOG(INFO) << this->schemeName_ << ", timestep " << timeStepNo << "/"
                << this->numberTimeSteps_ << ", t=" << currentTime;
    }
    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): time step " << timeStepNo << ", t: " << currentTime;

    // --------------- time stepping 1, time span = [0,dt]
    // -------------------------
    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): timeStepping1 setTimeSpan [" << currentTime << ", "
               << currentTime + this->timeStepWidth_ << "]";
    // set timespan for timestepping1
    this->timeStepping1_.setTimeSpan(currentTime,
                                     currentTime + this->timeStepWidth_);

    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): timeStepping1 advanceTimeSpan";
    ...
    // --------------- data transfer 1->2 -------------------------
    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): transfer timeStepping1 -> timeStepping2";
    ...
    if (VLOG_IS_ON(1))
      VLOG(1) << "  before transfer 1->2 timeStepping1_.getSlotConnectorData() "
              ...
              << StringUtility::demangle(
                     typeid(
                         decltype(this->timeStepping1_.getSlotConnectorData()))
                         .name())
              << ",\n  data: "
              << SlotConnectorDataHelper<
                     typename TimeStepping1::SlotConnectorDataType>::
                     getString(this->timeStepping1_.getSlotConnectorData());
    ...
    if (VLOG_IS_ON(1))
      VLOG(1) << "  after transfer 1->2 timeStepping2_.getSlotConnectorData(): "
              ...
              << StringUtility::demangle(
                     typeid(
                         decltype(this->timeStepping2_.getSlotConnectorData()))
                         .name())
              << ",\n  data: "
              << SlotConnectorDataHelper<
                     typename TimeStepping2::SlotConnectorDataType>::
                     getString(this->timeStepping2_.getSlotConnectorData());
    ...
    // -------------------------
    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): timeStepping2 setTimeSpan [" << currentTime << ", "
               << currentTime + this->timeStepWidth_ << "]";
    ...
    // --------------- data transfer 2->1 -------------------------
    LOG(DEBUG) << "  CouplingOrGodunov(\"" << this->description_
               << "\"): transfer timeStepping2 -> timeStepping1";
    ...
    if (VLOG_IS_ON(1))
      VLOG(1)
          << "  before transfer 2->1: timeStepping2_.getSlotConnectorData(): "
          << this->timeStepping2_.getSlotConnectorData();
    ...
    if (VLOG_IS_ON(1))
      VLOG(1)
          << "  after transfer 2->1: timeStepping1_.getSlotConnectorData(): "
          << this->timeStepping1_.getSlotConnectorData();
