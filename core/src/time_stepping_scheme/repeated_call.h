...
/** This class simply calls the advanceTimeSpan() method of the solver
 * repeatedly. It is similar to a Coupling class, but only involves one
 * sub-solver and no data transfer.
 */
template <typename Solver> class RepeatedCall : public TimeSteppingScheme {
public:
  //! constructor
