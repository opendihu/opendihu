...
meshes_tendon = {
  ...
  "tendon_Mesh": {
    ...
    "physicalOffset":     variables.right_tendon_offset,
    "logKey":             "tendon",
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
      ...
      "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "meshName":      "RightTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceSurfaceData": [  
        {
          ...
          "meshName":      "RightTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings file
        ...
        },
        {
          ...
          "meshName":      "RightTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
