...
variables.scenario_name = "left_tendon"
...
meshes_tendon = {
  ...
  "tendon_Mesh": {
    ...
    "physicalOffset":     variables.left_tendon_offset,
    "logKey":             "tendon",
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
      ...
      "preciceParticipantName":   "LeftTendonSolver",             # name of the own precice participant, has to match the name given in the precice xml config file
      "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "meshName":      "LeftTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceSurfaceData": [  
        {
          ...
          "meshName":      "LeftTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings file
        ...
        },
        {
          ...
          "meshName":      "LeftTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
