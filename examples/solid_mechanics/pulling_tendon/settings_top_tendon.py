  ...
  "Meshes":                         meshes_tendon,
    ...
    "PreciceAdapter": {        
      ...
      "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "meshName":      "TopTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceData": [  
        {
          ...
          "meshName":             "TopTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings file
        ...
        },
        {
          ...
          "meshName":      "TopTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
