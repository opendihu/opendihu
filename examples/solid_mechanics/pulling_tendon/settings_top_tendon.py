...
variables.scenario_name = "top_tendon"
...
meshes_tendon = {
  "tendon_Mesh": {
    "nElements" :         variables.top_n_elements_tendon,
    "physicalExtent":     variables.top_tendon_extent,
    "physicalOffset":     variables.top_tendon_offset,
    "logKey":             "tendon",
    "inputMeshIsGlobal":  True,
    "nRanks":             n_ranks
  },
  "tendon_Mesh_quadratic": {
    "nElements" :         [elems // 2 for elems in variables.top_n_elements_tendon],
    "physicalExtent":     variables.top_tendon_extent,
    "physicalOffset":     variables.top_tendon_offset,
...
[nx, ny, nz] = [elem + 1 for elem in variables.top_n_elements_tendon]
[mx, my, mz] = [elem // 2 for elem in variables.top_n_elements_tendon] # quadratic elements consist of 2 linear elements along each axis

# Dirichlet: fix the top of the tendon
k = nz-1 
...
config = {
  ...
  "Meshes":                         meshes_tendon,
    ...
    "PreciceAdapter": {        
      ...
      "preciceParticipantName":   "TopTendonSolver",             # name of the own precice participant, has to match the name given in the precice xml config file
      "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "preciceMeshName":      "TopTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceSurfaceData": [  
        {
          ...
          "preciceMeshName":             "TopTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings file
        ...
        },
        {
          ...
          "preciceMeshName":      "TopTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
