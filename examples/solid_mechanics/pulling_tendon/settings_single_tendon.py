...
config = {
  ...
  "Meshes":                         meshes_tendon,
    ...
    "DynamicHyperelasticitySolver": {
        ...
        "snesRebuildJacobianFrequency": variables.snes_rebuild_jacobian_frequency,          
        ...
        "divideNeumannBoundaryConditionValuesByTotalArea": variables.divideNeumannBoundaryConditionValuesByTotalArea,    # if the initial values for the dynamic nonlinear problem should be computed by extrapolating the previous displacements and velocities
