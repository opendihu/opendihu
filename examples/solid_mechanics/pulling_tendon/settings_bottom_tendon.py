...
config = {
  ...
  "PreciceAdapter": {        
      ...
      "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "meshName":      "BottomTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceData": [  
        {
          ...
          "meshName":             "BottomTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings file
        ...
        },
        {
          ...
          "meshName":      "BottomTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
