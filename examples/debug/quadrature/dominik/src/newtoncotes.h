 ...
 */
template <unsigned int NumberNCPoints> class NC : public Quadrature {
public:
  typedef NC<NumberNCPoints>
  ...
  //! return the sampling points, i.e. newton-cotes points that are needed for
  //! the quadrature. The list may not be in ascending order, but the order
