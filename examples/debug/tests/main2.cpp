...
int main(int argc, char *argv[]) {
  ...
  compileCommand << "gcc src/hodgkin_huxley_1952_1_0___gpu_101.0.c -fPIC -O3 "
                    "-march=native -shared-fopenmp-foffload=\"-O3 -lm "
                    "blabla\"-o lib/hodgkin_huxley_1952_1_0___gpu_101.so.0  && "
                    "mv lib/hodgkin_huxley_1952_1_0___gpu_101.so.0 "
                    "lib/hodgkin_huxley_1952_1_0___gpu_101.so";

  std::cout << "compileCommand: \"" << compileCommand.str() << "\"."
            << std::endl;
  ...
  std::cout << "newCompileCommand: \"" << newCompileCommand << "\"."
            << std::endl;
