...
if True:  
  ...
  if variables.paraview_output:
    ...
    variables.output_writer_fibers.append({"format": "Paraview", "outputInterval": int(1./variables.dt_splitting*variables.output_timestep_fibers/100), "filename": "out/fibers", "binary": True, "fixedFormat": False, "combineFiles": True})
