          ...
          "MapDofs": {
            ...
            "Heun" : {
              ...
              "CellML" : {
                ...
                "OutputWriter" : [
                  {"format": "PythonFile", "outputInterval": (int)(2), "filename": "out/muscle_spindles", "binary": True, "fixedFormat": False, "combineFiles": True, "onlyNodalValues": True, "fileNumbering": "incremental"}
                ]
              }
            }
          }
