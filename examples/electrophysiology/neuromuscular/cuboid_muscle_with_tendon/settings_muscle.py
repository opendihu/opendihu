...
config = {
  ...
  "MappingsBetweenMeshes": {"muscle_fiber{}".format(f) : ["muscleMesh", "muscleMesh_quadratic"] for f in range(variables.n_fibers_total)},
  "Solvers": {
  ...
  "PreciceAdapter" : {
    ...
    "preciceSurfaceData": [
      ...
      },
      {
        ...
        "meshName":      "MuscleMesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
    ...
    "Coupling": {
      ...
      "Term1": {
        ...
        # "MapDofs": {         
          ...
          # monodomain, fibers
          "MultipleInstances": {
            "logKey":                     "duration_subdomains_xy_muscle",
            ...
            "instances": [
              {
                ...
                "StrangSplitting": {
                  ...
                  "durationLogKey":         "duration_monodomain_muscle",
                  ...
                  "Term1": {
                    "MultipleInstances": {
                      "logKey":             "duration_subdomains_z_muscle",
                      ...
                      "instances": [
                        {
                          ...
                          "Heun" : {
                            ...
                            "durationLogKey":               "duration_0D_muscle",                           # log key of duration for this solver
                            ...
                            "CellML" : {
                              ...
                              "mappings":                               variables.muscle_mappings,                             # mappings between parameters and algebraics/constants and between outputConnectorSlots and states, algebraics or parameters, they are defined in helper.py

                              "meshName":                               "muscle_fiber{}".format(fiber_no),                # reference to the fiber mesh
                              "stimulationLogFilename":                 "out/" + variables.case_name + "/" + variables.scenario_name + "/stimulation_muscle.log",                          # a file that will contain the times of stimulations
                            },
                            "OutputWriter" : [
                              {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle_0D_states({},{})".format(fiber_in_subdomain_coordinate_x,fiber_in_subdomain_coordinate_y), "binary": True, "fixedFormat": False, "combineFiles": True}
                  ...
                  "Term2": {
                    "MultipleInstances": {
                      ...
                      "instances": [
                        {
                          ...
                          "ImplicitEuler": {
                            ...
                            "durationLogKey":              "duration_1D_muscle",                           # log key of duration for this solver
                            ...
                            "FiniteElementMethod" : {
                              "inputMeshIsGlobal":         True,
                              "meshName":                  "muscle_fiber{}".format(fiber_no),
                      ...
                      "OutputWriter" : [
                        {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle_fibers", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
                      ],
                    },
                  },
                }
      ...
      "Term2": {
        "MuscleContractionSolver": {
              ...
              "OutputWriter" : [
                {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle_contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
              ],
              "mapGeometryToMeshes":          ["muscleMesh"] + [key for key in fiber_meshes.keys() if "muscle_fiber" in key],    # the mesh names of the meshes that will get the geometry transferred
              ...
              "DynamicHyperelasticitySolver": {
                ...
                "durationLogKey":             "muscle_duration_mechanics",               # key to find duration of this solver in the log file
                ...
                "residualNormLogFilename":    "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_log_residual_norm.txt",   # log file where residual norm values of the nonlinear solver will be written
                ...
                "updateDirichletBoundaryConditionsFunction": None,                  # muscle_update_dirichlet_boundary_conditions_helper, function that updates the dirichlet BCs while the simulation is running
                ...
                "dirichletOutputFilename":     "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_dirichlet_boundary_conditions",     # output filename for the dirichlet boundary conditions, set to "" to have no output
                "totalForceLogFilename":       "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_tendon_force.csv",              # filename of a log file that will contain the total (bearing) forces and moments at the top and bottom of the volume
                "totalForceLogOutputInterval":       1,                                  # output interval when to write the totalForceLog file

                # define which file formats should be written
                # 1. main output writer that writes output files using the quadratic elements function space. Writes displacements, velocities and PK2 stresses.
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_displacements", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ...
                "pressure": {   # output files for pressure function space (linear elements), contains pressure values, as well as displacements and velocities
                  "OutputWriter" : [
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_pressure", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ]
                },
                # 3. additional output writer that writes virtual work terms
                "dynamic": {    # output of the dynamic solver, has additional virtual work values
                  "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_dynamic", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle_virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ],
                },
                # 4. output writer for debugging, outputs files after each load increment, the geometry is not changed but u and v are written
                "LoadIncrements": {
                  "OutputWriter" : [
                    #{"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle_load_increments", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ]
                }  
              }   
          # }
