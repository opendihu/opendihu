...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
      ...
      "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "meshName":      "TendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceSurfaceData": [  
        ...
        },
        {
          ...
          "meshName":      "TendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
