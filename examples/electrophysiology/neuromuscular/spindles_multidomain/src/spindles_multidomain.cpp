...
// define helper function space for various activation signals, this is actually
// a vector space
typedef FunctionSpace::FunctionSpace<Mesh::StructuredRegularFixedOfDimension<1>,
...
int main(int argc, char *argv[]) {
  ...
  Control::MultipleCoupling<
      ...
      PrescribedValues<FunctionSpace::FunctionSpace<
          Mesh::CompositeOfDimension<3>, BasisFunction::LagrangeOfOrder<1>>>,
      // Term2: quasi-static mechanics solver for "precontraction"
      MuscleContractionSolver<Mesh::CompositeOfDimension<3>>,
      // Term3: static trans-iso material for "prestretch"
      SpatialDiscretization::HyperelasticitySolver<
          Equation::SolidMechanics::
              TransverselyIsotropicMooneyRivlinIncompressible3D,
          true, Mesh::CompositeOfDimension<3>>,
      ...
      Control::MultipleCoupling<
          ...
          Control::MapDofs<
              ...
              Control::MapDofs<
                  ...
                  Control::Coupling<
                      // Multidomain, Strang splitting of CellmlAdapter and
                      // MultidomainWithFatSolver
                      OperatorSplitting::Strang<
                          Control::MultipleInstances<
                              TimeSteppingScheme::Heun<CellmlAdapter<
                                  9, 19, // nStates,nAlgebraics: 57,1 = Shorten,
                                         // 4,9 = Hodgkin Huxley
                                  FunctionSpace::FunctionSpace<
                                      MeshType, BasisFunction::LagrangeOfOrder<
                                                    1>> // same function space
                                                        // as for anisotropic
                                                        // diffusion
                                  >>>,
                          OutputWriter::OutputSurface<
                              TimeSteppingScheme::
                                  MultidomainWithFatSolver< // multidomain
                                      SpatialDiscretization::
                                          FiniteElementMethod< // FEM for
                                                               // initial
                                                               // potential
                                                               // flow, fibre
                                                               // directions
                                      ...
                                      SpatialDiscretization::
                                          FiniteElementMethod< // anisotropic
                                                               // diffusion
                                              MeshType,
                                              BasisFunction::LagrangeOfOrder<1>,
                                              Quadrature::Gauss<3>,
