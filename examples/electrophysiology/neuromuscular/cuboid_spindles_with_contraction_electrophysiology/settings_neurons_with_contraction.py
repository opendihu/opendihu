        ...
        "Coupling": {
                        ...
                        [{
                          ...
                          "ImplicitEuler" : {
                            ...
                            "FiniteElementMethod" : {
                              ...
                              "prefactor":                 get_diffusion_prefactor(fiber_no, 1),  # resolves to Conductivity / (Am * Cm)
                              "slotName":                  "vm",
                            },
                            "OutputWriter" : [
          ...
          "MuscleContractionSolver": {
            ...
            "DynamicHyperelasticitySolver": {
              ...
              "neumannBoundaryConditions":   variables.contraction_neumann_bc,     # Neumann boundary conditions that define traction forces on surfaces of elements
