...
variables.elasticity_neumann_bc = [{
  ...
  "constantVector": [10.0, 0, 0], 
  "face": "2-", 
  "isInReferenceConfiguration": False} for j in range(ny) for i in range(nx)]

variables.scenario_name = "current_configuration"
#variables.scenario_name = "reference_configuration"
#variables.elasticity_neumann_bc = []
