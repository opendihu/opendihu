...
config_hyperelasticity = {    # for both "HyperelasticitySolver" and "DynamicHyperelasticitySolver"
  ...
  "totalForceFunction":          None,                                # callback function that gets the total force at bottom and top of the domain
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
    ...
    "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "TendonMeshBottomA",        # precice name of the 2D coupling mesh
    ...
    "preciceSurfaceData": [
      {
        ...
        "preciceMeshName":      "TendonMeshBottomA",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "TendonMeshBottomA",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
