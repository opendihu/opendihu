...
variables.scenario_name = "linear_tendon_dynamic"
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
    ...
    "DynamicHyperelasticitySolver": {
      ...
      "snesMaxIterations":          30,                           # maximum number of iterations in the nonlinear solver
      "snesRelativeTolerance":      1e-3,                         # relative tolerance of the nonlinear solver
      "snesLineSearchType":         "l2",                         # type of linesearch, possible values: "bt" "nleqerr" "basic" "l2" "cp" "ncglinear"
      "snesAbsoluteTolerance":      15,                         # absolute tolerance of the nonlinear solver
