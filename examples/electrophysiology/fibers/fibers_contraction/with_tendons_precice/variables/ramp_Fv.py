...
dt_1D = 4e-4                        # [ms] timestep width of diffusion (1e-3)
dt_splitting = 4e-4                 # [ms] overall timestep width of strang splitting (1e-3)
dt_3D = 0.1                           # [ms] time step width of coupling, when 3D should be performed, also sampling time of monopolar EMG
output_timestep_3D = 10              # [ms] timestep for output of fibers and mechanics, should be a multiple of dt_3D
output_timestep_fibers = int(dt_3D/dt_splitting)*output_timestep_3D
