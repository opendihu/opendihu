...
variables.scenario_name = "tendon_linear"
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
    ...
    "HyperelasticitySolver": {
      ...
      "snesRelativeTolerance":      1e-7,                         # relative tolerance of the nonlinear solver
      ...
      #"loadFactors":                list(np.logspace(-6,0,15)),   # load factors for every timestep
      ...
      "OutputWriter" : [
        ...
        {"format": "PythonFile", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/tendon", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
