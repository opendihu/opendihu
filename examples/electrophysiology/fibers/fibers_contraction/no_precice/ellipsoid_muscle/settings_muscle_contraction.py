...
config = {
  ...
  "MappingsBetweenMeshes": { 
      "mesh3D" : ["fiber{}".format(index) for index in range(variables.n_fibers)]
  },
    ...
    "Term2": { # solid mechanics (MuscleContractionSolver)
      "MuscleContractionSolver": {
        ...
        "DynamicHyperelasticitySolver": {
          ...
          "initialValuesDisplacements": [[0, 0, 0] for _ in range((variables.el_x + 1) * (variables.el_y +1) * (variables.el_z+1))],
          "initialValuesVelocities":    [[0, 0, 0] for _ in range((variables.el_x + 1) * (variables.el_y +1) * (variables.el_z+1))],
