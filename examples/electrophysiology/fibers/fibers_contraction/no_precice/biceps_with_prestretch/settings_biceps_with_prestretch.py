...
def printPrestretch(result):
  print("Prestretch simulation")
  ...
  "Coupling" : {
    ...
    "Term1": {
      "Coupling": {
        "numberTimeSteps":        1,
        "timeStepOutputInterval": 1,
        "logTimeStepWidthAsKey":  "dt_prestretch",
        "durationLogKey":         "duration_prestretch",
                ...
                "Term1": {      # CellML, i.e. reaction term of Monodomain equation
                  "MultipleInstances": {
                    ...
                    [{
                      ...
                      "Heun" : {
                        "numberTimeSteps":              1,                                       # timestep width of 0D problem
        ...
        "Term2": {        # solid mechanics
          "MuscleContractionSolver": {
            ...
            "OutputWriter" : [
              ...
              {"format": "PythonCallback", "outputInterval": 1, "callback": printPrestretch},
      ...
      "Coupling": {
        ...
        "Term2": {        # solid mechanics
          "MuscleContractionSolver": {
            ...
            "enableForceLengthRelation":    variables.enable_force_length_relation,  # if the factor f_l(λ_f) modeling the force-length relation (as in Heidlauf2013) should be multiplied. Set to false if this relation is already considered in the CellML model.
            "lambdaDotScalingFactor":       variables.lambda_dot_scaling_factor,     # scaling factor for the output of the lambda dot slot, i.e. the contraction velocity. Use this to scale the unit-less quantity to, e.g., micrometers per millisecond for the subcellular model.
            "slotNames":                    ["lambdaContraction", "ldotContraction", "gammaContraction", "TContraction"],   # names of the data slots (lamdba, lambdaDot, gamma, traction), maximum 10 characters per slot name
            "OutputWriter" : [
              {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.scenario_name + "/contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
            ],
            "mapGeometryToMeshes":          [],                        # the mesh names of the meshes that will get the geometry transferred
