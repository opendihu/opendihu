...
config = {
  ...
  "DynamicHyperelasticitySolver": {
      ...
      "OutputWriter" : [
          {"format": "Paraview", "outputInterval": variables.output_interval, "filename": "out/" + variables.scenario_name + "_mechanics_3D", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
      ],
