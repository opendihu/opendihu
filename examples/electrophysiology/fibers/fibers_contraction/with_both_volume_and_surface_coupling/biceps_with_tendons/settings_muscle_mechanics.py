...
config = {
  ...
  "PreciceAdapter": {
    ...
    "preciceParticipantName":   "MuscleMechanics",        # name of the own precice participant, has to match the name given in the precice xml config file
    ...
    "preciceVolumeData": [
      {
        ...
        "preciceMeshName":      "MuscleMechanicsMesh",    # name of the precice coupling mesh, as given in the precice xml settings file
